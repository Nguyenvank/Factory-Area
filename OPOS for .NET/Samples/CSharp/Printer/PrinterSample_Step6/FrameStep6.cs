...
namespace PrinterSample_Step6
{
	...
	public class FrameStep6 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.grpReceipt.Location = new System.Drawing.Point(32, 40);
			this.grpReceipt.Name = "grpReceipt";
			this.grpReceipt.Size = new System.Drawing.Size(220, 92);
			...
			// btnPrint
			// 
			this.btnPrint.Location = new System.Drawing.Point(40, 40);
			...
			// btnClose
			// 
			this.btnClose.Location = new System.Drawing.Point(140, 148);
			...
			this.Text = "Step 6  Use the TransactionPrint";
		...
		private void frmStep6_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                if (m_Printer.CapRecBitmap == true)
                {
                    ...
                    {
                        MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep6"
