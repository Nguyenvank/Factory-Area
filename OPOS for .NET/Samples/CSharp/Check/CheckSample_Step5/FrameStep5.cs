...
namespace CheckSample_Step5
{
	...
	public class FrameStep5 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRead
			// 
			this.btnRead.Location = new System.Drawing.Point(24, 116);
			...
			// btnExit
			// 
			this.btnExit.Location = new System.Drawing.Point(376, 304);
			...
			this.btnStore.Location = new System.Drawing.Point(24, 190);
			...
			this.btnCreateFile.Location = new System.Drawing.Point(24, 227);
			...
			this.grpCroppinArea.Location = new System.Drawing.Point(184, 116);
			...
			// btnAttachMICR
			// 
			this.btnAttachMICR.Location = new System.Drawing.Point(24, 153);
			...
			// btnReadMemory
			// 
			this.btnReadMemory.Location = new System.Drawing.Point(24, 264);
			...
			// cmbMemoyData
			// 
			this.cmbMemoyData.Location = new System.Drawing.Point(188, 268);
			this.cmbMemoyData.Name = "cmbMemoyData";
			this.cmbMemoyData.Size = new System.Drawing.Size(192, 20);
			...
			this.Name = "frmStep5";
			this.Text = "Step 5 Adding a function attached data with MICR data.";
		...
		private void btnStore_Click(object sender, System.EventArgs e)
		{
			...
			{
				// Set FileID
				m_CheckScanner.FileId = "Epson CheckScanner SampleProgram Step5";
			}
			catch(PosControlException)
			{
			}
			...
			{
				// Set ImageTagData
				m_CheckScanner.ImageTagData = "Epson CheckScanner SampleProgram Step5 ImageTagData"
					+ m_strMicrRawData;
			}
			catch(PosControlException)
			{
			...
			MessageBox.Show("A data was stored.","CheckSample_Step5",MessageBoxButtons.OK);	
			//<<<step2>>>--End
		}
		...
		private void btnCreateFile_Click(object sender, System.EventArgs e)
		{
			...
			if(Image != null)
			{
				...
				strImageFilePath += "\\Step5." + strImageFormat;
				...
				//Finish message
				MessageBox.Show("A file was created","CheckSample_Step5",MessageBoxButtons.OK);
				//<<<step3>>>--End
			}
		}
		...
		private void frmStep5_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","CheckSample_Step5");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			}
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","CheckSample_Step5",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("This device has not been registered, or cannot use."
					,"CheckSample_Step5",MessageBoxButtons.OK);
			...
			{
				MessageBox.Show("Failed to get exclusive rights to the device.","CheckSample_Step5"
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","CheckSample_Step5",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("This device has not been registered, or cannot use.","CheckSample_Step5"
					,MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","CheckSample_Step5"
					,MessageBoxButtons.OK);
		...
		/// <summary>
		/// Remove ErrorEventHandlerHandler.
		/// </summary>
		/// <param name="eventSource"></param>
		...
		protected void OnErrorEvent(object source, DeviceErrorEventArgs e )
        {
			...
			if(source is CheckScanner)
			{
				MessageBox.Show("CheckScanner Error\n" + "ErrorCode =" + e.ErrorCode.ToString() + "\n"
					+ "ErrorCodeExtended =" +e.ErrorCodeExtended.ToString() ,"CheckSample_Step5"
					,MessageBoxButtons.OK);
			}
