...
#Region " Windows Forms Designer generated code."
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrameStep15"
        Me.Text = "Step15 Print Memory Bitmap"
...
#End Region
    ...
    , ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        Try
			...
			Dim strFilePath As String = strCurDir.Substring(0, strCurDir.IndexOf("Step15") + "Step15\".Length)
			
            'Append the bitmap file name
            strFilePath += "Logo.bmp"

            'Create the bitmap object from the file
            Dim bitmap As System.Drawing.Bitmap = New System.Drawing.Bitmap(strFilePath, True)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub FrameStep15_Load(ByVal sender As System.Object _
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub FrameStep15_Closing(ByVal sender As Object _
