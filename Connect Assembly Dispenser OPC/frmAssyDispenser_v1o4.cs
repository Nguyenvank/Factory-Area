...
namespace Fan_1
{
    public partial class frmAssyDispenser_v1o4 : Form
    {
        public int run = 1;
        ...
        private void frmAssyDispenser_v1o4_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        private void frmAssyDispenser_v1o4_Resize(object sender, EventArgs e)
        {
