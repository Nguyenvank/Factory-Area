...
namespace Fan_1
{
    public partial class frmAssyDispenser_v1o5 : Form
    {
        public int run = 1;
        ...
        public frmAssyDispenser_v1o5()
        {
            ...
            timer_PulsePLC_01.Interval = timer_PulsePLC_02.Interval = 250;
        ...
        private void frmAssyDispenser_v1o5_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        private void frmAssyDispenser_v1o5_Resize(object sender, EventArgs e)
        {
