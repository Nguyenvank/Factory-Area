...
{
    public partial class frmWarehouseMaterialScanInWH1_v1o2 : Form
    {
        public string _locId = "101";     //warehouse ID
        ...
        public frmWarehouseMaterialScanInWH1_v1o2()
        {
            InitializeComponent();
        ...
        private void frmWarehouseMaterialScanInWH1_v1o2_Load(object sender, EventArgs e)
        {
        ...
        private void txtPackCode_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (packCode != "" && packCode != null)
                {
                    if (packCode.IndexOf("-") > 0)
                    {
                        ...
                        if (vendor.Length > 0)
                        {
                            ...
                            else
                            {
                                ...
                                lblMessage.Text = "Sai mã packing";
                            }
                        }
                        else
                        {
                    ...
                    {
                        //lblMessage.Text = "Invalid packing code. Please try again.";
                        lblMessage.Text = "Không đúng kiểu cho mã packing";
                    }
                }
                else
                {
