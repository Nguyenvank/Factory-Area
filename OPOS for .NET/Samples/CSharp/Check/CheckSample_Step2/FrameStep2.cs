...
namespace CheckSample_Step2
{
	...
	public class FrameStep2 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnExit
			// 
			this.btnExit.Location = new System.Drawing.Point(316, 148);
			...
			this.btnStore.Location = new System.Drawing.Point(316, 108);
			...
			this.Text = "Step 2 Adding \"Store Image\" function.";
		...
		private void btnStore_Click(object sender, System.EventArgs e)
		{
			...
			{
				// Set FileID
				m_CheckScanner.FileId = "Epson CheckScanner SampleProgram Step2";
			}
			catch(PosControlException)
			{
			}
			...
			{
				// Set ImageTagData
				m_CheckScanner.ImageTagData = "Epson CheckScanner SampleProgram Step2 ImageTagData";
			}
			catch(PosControlException)
			{
			}
			...
			MessageBox.Show("A data was stored.","CheckSample_Step2",MessageBoxButtons.OK);		
			//<<<step2>>>--End
		}
		...
		protected void OnErrorEvent(object source, DeviceErrorEventArgs e )
        {
			...
			MessageBox.Show("CheckScanner Error\n" + "ErrorCode =" + e.ErrorCode.ToString() 
				...
				,"CheckSample_Step2",MessageBoxButtons.OK);
			//<<<step1>>>--End
		}
