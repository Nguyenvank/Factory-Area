...
{
    public partial class frmWarehouseMaterialScanInWH1 : Form
    {
        ...
        public frmWarehouseMaterialScanInWH1()
        {
            InitializeComponent();
        }
        ...
        public void fnGetQty(string prodId)
        {
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    lblPCS.Text = ds.Tables[0].Rows[0][4].ToString();
                    lblBOX.Text = ds.Tables[0].Rows[0][5].ToString();
                    lblPAK.Text = ds.Tables[0].Rows[0][6].ToString();
                    lblPAL.Text = ds.Tables[0].Rows[0][7].ToString();
        ...
        private void btnExport2Excel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                export = cls.ExportToExcel(dgvScanList, "Resin " + String.Format("{0:dd-MM-yyyy}", DateTime.Now));
        ...
        private void deleteThisPackingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!dgvScanList.Rows[rowIndex].IsNewRow)
            {
                ...
                if (dialogResultAdd == DialogResult.Yes)
                {
                    ...
                    string sql = "V2o1_BASE_Warehouse_Material_ScanIn_DelItem_Addnew";
                    SqlParameter[] sParams = new SqlParameter[9]; // Parameter count
