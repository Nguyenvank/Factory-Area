...
namespace Inventory_Data
{
    public partial class frmWarehouseMaterialRequest : Form
    {
        ...
        public void fnBindMaterial()
        {
            try
            {
                string sql = "V2o1_BASE_Warehouse_HR_Material_Request_Material_SelItem_Addnew";
        ...
        {
            string sql = "V2o1_BASE_Warehouse_HR_Material_Request_PIC_SelItem_Addnew";
            DataTable dt = new DataTable();
            dt = cls.fnSelect(sql);
        ...
        public void fnFindMaterial()
        {
            ...
            //(dgvMaterial.DataSource as DataTable).DefaultView.RowFilter = string.Format("Name LIKE '{0}%' OR Name LIKE '% {0}%'", txtFilter.Text);
            (dgvMaterial.DataSource as DataTable).DefaultView.RowFilter = string.Format("Name LIKE '%{0}%'", txtFilter.Text);


            //BindingSource bs = new BindingSource();
            //bs.DataSource = dgvMaterial.DataSource;
            //bs.Filter = string.Format("CONVERT(" + dgvMaterial.Columns[1].DataPropertyName.ToLower() + ", System.String) like '%" + txtFilter.Text.ToLower().Replace("'", "''") + "%'");
        ...
        {
            string sql = "V2o1_BASE_Warehouse_HR_Material_Request_OrderList_SelItem_Addnew";
            DataTable dt = new DataTable();
            dt = cls.fnSelect(sql);
