...
namespace Inventory_Data
{
    public partial class frmAssyProductionMonitoring : Form
    {
        ...
        public void fnBindAssyMonitor()
        {
            ...
            dgvAssyMonitor.Columns[12].Width = 25 * _dgvAssyMonitorWidth / 100;    // remark
            ...
            cls.fnFormatDatagridview(dgvAssyMonitor, 20, 80);
        }
        ...
        private void dgvAssyMonitor_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dgvAssyMonitor.Rows)
            {
                ...
                _orderDate = (row.Cells[1].Value.ToString() != "N/A") ? Convert.ToDateTime(row.Cells[1].Value.ToString()) : DateTime.Now;
