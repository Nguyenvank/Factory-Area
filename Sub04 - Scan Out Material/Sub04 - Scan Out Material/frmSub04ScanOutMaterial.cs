...
namespace Inventory_Data
{
    public partial class frmSub04ScanOutMaterial : Form
    {
        ...
        public frmSub04ScanOutMaterial()
        {
            ...
            cls.SetDoubleBuffer(dgvOut_Request, true);
            cls.SetDoubleBuffer(dgvOut_Detail, true);
            cls.SetDoubleBuffer(dgvOut_List, true);
            cls.SetDoubleBuffer(dgvAprv_List, true);
            cls.SetDoubleBuffer(dgvAprv_Detail, true);
            cls.SetDoubleBuffer(dgvUnAprv_List, true);
            cls.SetDoubleBuffer(dgvOut_Bind_List, true);
            cls.SetDoubleBuffer(dgvOut_Bind_Detail, true);
        ...
        private void dgvOut_Request_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    //MessageBox.Show(_outIDx.ToString());
                    initOut_Detail();
        ...
        private void lnk_ScanOut_Spare_Copy_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            cls.Fnc_Save_To_CSV(dgvScanOut_Spare_List);
        }
        ...
        private void btnOut_Bind_Print_Delivery_Bill_Click(object sender, EventArgs e)
        {
            ...
            uc_MNT_SpareScanOut_PrintBill_v1o1 frm04Print = new uc_MNT_SpareScanOut_PrintBill_v1o1(_bindOrderIDx);
