...
namespace Fan_1
{
    public partial class frmTempFromPLC_R_V1o3 : Form
    {
        public int run = 1;
        ...
        private void frmTempFromPLC_R_V1o3_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        private void frmTempFromPLC_R_V1o3_Resize(object sender, EventArgs e)
        {
        ...
        public void fnUpdateTemp()
        {
            ...
            string R19_SV = String.Format("{0:0000}", Convert.ToInt32(lbl_R19_SV.Text));
            string R19_PV = String.Format("{0:0000}", Convert.ToInt32(lbl_R19_PV.Text));
            string R19_AL = String.Format("{0:0000}", Convert.ToInt32(lbl_R19_AL.Text));

            string R20_SV = String.Format("{0:0000}", Convert.ToInt32(lbl_R20_SV.Text));
            string R20_PV = String.Format("{0:0000}", Convert.ToInt32(lbl_R20_PV.Text));
            string R20_AL = String.Format("{0:0000}", Convert.ToInt32(lbl_R20_AL.Text));
