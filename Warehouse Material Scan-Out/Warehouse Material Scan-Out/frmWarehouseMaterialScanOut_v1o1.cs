...
{
    public partial class frmWarehouseMaterialScanOut_v1o1 : Form
    {
        string __msg = "";
        ...
        public frmWarehouseMaterialScanOut_v1o1()
        {
            InitializeComponent();
        ...
        private void frmWarehouseMaterialScanOut_v1o1_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
                    ...
                    if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (packType == "MMT")
                        {
                            ...
                            if (dsExist.Tables.Count > 0 && dsExist.Tables[0].Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (msgType == 1)
                                    {
                                        ...
                                        frmWarehouseMaterialScanOut_v1o1_Message msg = new frmWarehouseMaterialScanOut_v1o1_Message(msg1 + msg2 + msg3 + msg4, msgType.ToString());
                                        msg.ShowDialog();
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                frmWarehouseMaterialScanOut_v1o1_Message msg = new frmWarehouseMaterialScanOut_v1o1_Message(msg_02, "1");
                                msg.ShowDialog();
                            }
                        }
                        else
        ...
        private void lblMessage_DoubleClick(object sender, EventArgs e)
        {
            ...
            frmWarehouseMaterialScanOut_v1o1_Message msg = new frmWarehouseMaterialScanOut_v1o1_Message(mess, "1");
            msg.ShowDialog();
        }
    }
}
