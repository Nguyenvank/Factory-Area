...
namespace CheckSample_Step7
{
	...
	public class FrameStep7 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnExit
			// 
			this.btnExit.Location = new System.Drawing.Point(380, 356);
			...
			this.btnStore.Location = new System.Drawing.Point(20, 180);
			...
			this.btnCreateFile.Location = new System.Drawing.Point(20, 216);
			...
			// btnAttachMICR
			// 
			this.btnAttachMICR.Location = new System.Drawing.Point(20, 148);
			...
			// lblCurrentMode
			// 
			this.lblCurrentMode.Location = new System.Drawing.Point(84, 288);
			this.lblCurrentMode.Name = "lblCurrentMode";
			this.lblCurrentMode.Size = new System.Drawing.Size(80, 20);
			this.lblCurrentMode.TabIndex = 13;
			this.lblCurrentMode.Text = "CurrentMode : ";
			// 
			// btnRetrieveStatistics
			// 
			this.btnRetrieveStatistics.Location = new System.Drawing.Point(20, 320);
			this.btnRetrieveStatistics.Name = "btnRetrieveStatistics";
			this.btnRetrieveStatistics.Size = new System.Drawing.Size(144, 24);
			this.btnRetrieveStatistics.TabIndex = 14;
			...
			// txtStatistics
			// 
			this.txtStatistics.Location = new System.Drawing.Point(188, 320);
			this.txtStatistics.Name = "txtStatistics";
			this.txtStatistics.Size = new System.Drawing.Size(268, 19);
			this.txtStatistics.TabIndex = 15;
			...
			this.cmbCurrentMode.TabIndex = 16;
			...
			this.Name = "FrameStep7";
			this.Text = "Step 7 Obtains the statistics of the device.";
		...
		private void btnStore_Click(object sender, System.EventArgs e)
		{
			...
			{
				// Set ImageTagData
				m_CheckScanner.ImageTagData = "Epson CheckScannerScanner SampleProgram Step7 ImageTagData"
					+ m_strMicrRawData;
			}
			catch(PosControlException)
			{
			...
			MessageBox.Show("A data was stored.","CheckSample_Step7",MessageBoxButtons.OK);	
			//<<<step2>>>--End
		}
		...
		private void btnCreateFile_Click(object sender, System.EventArgs e)
		{
			...
			if(Image != null)
			{
				...
				//Finish message
				MessageBox.Show("A file was created","CheckSample_Step7",MessageBoxButtons.OK);
		...
		private void frmStep7_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","CheckSample_Step7");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			}
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","CheckSample_Step7",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("This device has not been registered, or cannot use."
					,"CheckSample_Step7",MessageBoxButtons.OK);
			...
			{
				MessageBox.Show("Failed to get exclusive rights to the device.","CheckSample_Step7"
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","CheckSample_Step7",MessageBoxButtons.OK);
			...
			{
				//Failed CreateInstance
				MessageBox.Show("Failed to create instance","CheckSample_Step7"
					,MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","CheckSample_Step7"
					,MessageBoxButtons.OK);
			...
			//<<<step7>>>--Start
			if(m_CheckScanner.CapStatisticsReporting == false)
			{
				btnRetrieveStatistics.Enabled = false;
				txtStatistics.Enabled = false;
			}
		...
		protected void OnErrorEvent(object source, DeviceErrorEventArgs e )
		{
			...
			if(source is CheckScanner)
			{
				MessageBox.Show("CheckScanner Error\n" + "ErrorCode =" + e.ErrorCode.ToString() + "\n"
					+ "ErrorCodeExtended =" +e.ErrorCodeExtended.ToString() ,"CheckSample_Step7"
					,MessageBoxButtons.OK);
			}
