...
namespace MicrSample_Step2
{
	...
	public class FrameStep2 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Text = "Step 2 Adding \"Time-out\" function.";
				...
				catch(PosControlException pex)
				{
					...
					if (pex.ErrorCode == ErrorCode.Timeout) 
					{
						...
						dialogResult = MessageBox.Show("Please insert a check."
							,"MicrSample_Step2",MessageBoxButtons.YesNo);
		...
		private void btnRemove_Click(object sender, System.EventArgs e)
		{
			...
			catch(PosControlException pex)
			{
				...
				if (pex.ErrorCode == Microsoft.PointOfService.ErrorCode.Timeout) 
				{
					MessageBox.Show("Please remove a check.","MicrSample_Step2");
				}
			}
			//<<<step2>>>--End
		}
