...
namespace Fan_1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            ItemCount = 3;
            OPCItemIDs.SetValue("Channel1.Device1.WeightBalance01_OK", 1);
            ClientHandles.SetValue(1, 1);
            OPCItemIDs.SetValue("Channel1.Device1.WeightBalance02_OK", 2);
            ClientHandles.SetValue(2, 2);
            OPCItemIDs.SetValue("Channel1.Device1.WeightBalance03_OK", 3);
        ...
        private void ObjOPCGroup_DataChange(int TransactionID, int NumItems, ref Array ClientHandles, ref Array ItemValues, ref Array Qualities, ref Array TimeStamps)
        {
            ...
            for (int i = 1; i <= NumItems; i++)
            {
                ...
                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 1)
                {
                    ...
                    {
                        pictureBox1.Image = new Bitmap(System.IO.Path.GetFullPath(@"Resources\1h9orm.gif"));
                    }


                    else
                    {
                        pictureBox1.Image = new Bitmap(System.IO.Path.GetFullPath(@"Resources\Stop.png"));
        ...
        private void Btn_Start_Click(object sender, EventArgs e)
        {
            ...
            //try
            //{
            ////OPCItem newOPC = ConnectedGroup.OPCItems.AddItem("Channel1.Device1.WeightBalance01_OK", 1);
        ...
        private void Bt_Write_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                ////OPCItem newOPC = ConnectedGroup.OPCItems.AddItem("Channel1.Device1.WeightBalance02_OK", 2);
