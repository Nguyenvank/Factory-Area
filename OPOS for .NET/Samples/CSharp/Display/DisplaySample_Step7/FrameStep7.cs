...
namespace DisplaySample_Step7
{
	...
	public class FrameStep7 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmStep6";
			this.Text = "Step 7 Adding error handlers.";
		...
		private void btnWindowControl_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				MessageBox.Show("When pressing OK, it ends.","DisplaySample_Step7"
		...
		private void frmStep7_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","DisplaySample_Step7");
				//Nothing can be used.
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","DisplaySample_Step7"
					,MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("This device has not been registered, or cannot use."
					,"DisplaySample_Step7",MessageBoxButtons.OK);
				ChangeButtonStatus(false);
				return;
			}
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","DisplaySample_Step7"
					,MessageBoxButtons.OK);
		...
		protected  void OnStatusUpdateEvent(object source, StatusUpdateEventArgs e)
        {
			...
			switch(e.Status)
			{
				...
				case PosCommon.StatusPowerOnline:
					MessageBox.Show("The device is powered on.","DisplaySample_Step7"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(true);
					break;
					//The device is powered off, or unconnected.
				case PosCommon.StatusPowerOff:
					MessageBox.Show("The device is powered off","DisplaySample_Step7"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(false);
					break;
				...
				case PosCommon.StatusPowerOffOffline:
					MessageBox.Show("The device is powered off or off-line.","DisplaySample_Step7"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(false);
					break;
				default:
