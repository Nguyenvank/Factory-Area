...
namespace MicrSample_Step3
{
	...
	public class FrameStep3 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmStep3";
			this.Text = "Step 3   Display detailed information of the read data.";
				...
				catch(PosControlException pex)
				{
					...
					if (pex.ErrorCode == ErrorCode.Timeout) 
					{
						...
						dialogResult = MessageBox.Show("Please insert a check."
							,"MicrSample_Step3",MessageBoxButtons.YesNo);
		...
		private void btnRemove_Click(object sender, System.EventArgs e)
		{
			...
			catch(PosControlException pex)
			{
				...
				if (pex.ErrorCode == ErrorCode.Timeout) 
				{
					MessageBox.Show("Please remove a check.","MicrSample_Step3");
				}
			}
			//<<<step2>>>--End
		}
