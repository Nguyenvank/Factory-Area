...
namespace PrinterSample_Step13
{
	/// <summary>
	///  Description of FrameStep13.
	/// </summary>
	public class FrameStep13 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.grpReceipt.Location = new System.Drawing.Point(68, 13);
            this.grpReceipt.Name = "grpReceipt";
            this.grpReceipt.Size = new System.Drawing.Size(208, 156);
            ...
            // btnAsync
            // 
            this.btnAsync.Location = new System.Drawing.Point(20, 74);
            this.btnAsync.Name = "btnAsync";
            this.btnAsync.Size = new System.Drawing.Size(164, 26);
            ...
            // btnPrint
            // 
            this.btnPrint.Location = new System.Drawing.Point(20, 30);
            this.btnPrint.Name = "btnPrint";
            this.btnPrint.Size = new System.Drawing.Size(164, 26);
            ...
            // btnReceipt
            // 
            this.btnReceipt.Location = new System.Drawing.Point(20, 113);
            this.btnReceipt.Name = "btnReceipt";
            this.btnReceipt.Size = new System.Drawing.Size(164, 26);
            ...
            this.grpSlp.Location = new System.Drawing.Point(68, 178);
            this.grpSlp.Name = "grpSlp";
            this.grpSlp.Size = new System.Drawing.Size(208, 73);
            ...
            // btnSales
            // 
            this.btnSales.Location = new System.Drawing.Point(20, 30);
            this.btnSales.Name = "btnSales";
            this.btnSales.Size = new System.Drawing.Size(164, 26);
            ...
            this.grpStatistics.Location = new System.Drawing.Point(72, 269);
            this.grpStatistics.Name = "grpStatistics";
            this.grpStatistics.Size = new System.Drawing.Size(204, 108);
            ...
            // btnClose
            // 
            this.btnClose.Location = new System.Drawing.Point(180, 386);
            ...
            this.Name = "FrameStep13";
            this.Text = "Step 13 Obtains the statistics of the device.";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.frmStep13_Closing);
            this.Load += new System.EventHandler(this.frmStep13_Load);
		...
		static void Main() 
		{
			Application.Run(new FrameStep13());
		}
			...
			try
			{
				if (m_Printer.CapRecPresent == true)
				{
					...
					{			
						...
						{
							MessageBox.Show("Cannot use a POS Printer.","Printer_SampleStep13"
		...
		private void btnReceipt_Click(object sender, System.EventArgs e)
		{
			...
			string strFilePath = strCurDir.Substring(0,strCurDir.LastIndexOf("Step13") + "Step13\\".Length);
		...
		private bool WaitForInsertion()
		{
			...
			while(true)
			{
				...
				catch(PosControlException pex)
				{
					...
					{
						dialogResult =  MessageBox.Show("Please insert a form.","PrinterSample_Step13"
					...
					else
					{
						...
						MessageBox.Show(strMessage,"PrinterSample_Step13");
						bInsertion = false;
					}
				}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void frmStep13_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","Printer_SampleStep13");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			}
			...
			{
				MessageBox.Show("Failed to create instance.","Printer_SampleStep13");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			...
			{
				MessageBox.Show("Failed to open the device.","Printer_SampleStep13");
			...
			{
				MessageBox.Show("Failed to claim the device.","Printer_SampleStep13");
            ...
            if (m_Printer.CapRecBitmap == true)
            {
                ...
                {
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep13"
                            , MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
			//<<<step3>>>--End
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void frmStep13_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			//<<<step1>>>--Start
			if(m_Printer != null)
			{
		...
		protected  void OnErrorEvent(object source, DeviceErrorEventArgs e )
        {
			...
			dialogResult =  MessageBox.Show(strMessage,"Printer_SampleStep13"
