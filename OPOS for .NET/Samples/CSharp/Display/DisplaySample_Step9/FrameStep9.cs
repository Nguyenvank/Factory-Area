...
namespace DisplaySample_Step9
{
	...
	public class FrameStep9 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnClose
			// 
			this.btnClose.Location = new System.Drawing.Point(392, 220);
			...
			this.Name = "frmStep9";
			this.Text = "Step 9 Display bitmaps.";
		...
		private void btnWindowControl_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				MessageBox.Show("When pressing OK, it ends.","DisplaySample_Step9"
		...
		private void btnSetChracterOrnaments_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				m_Display.DisplayTextAt(0,0,"Normal" + "\u001b|bCBold");
		...
		private void frmStep9_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","DisplaySample_Step9");
				//Nothing can be used.
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","DisplaySample_Step9"
					,MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("This device has not been registered, or cannot use."
					,"DisplaySample_Step9",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				MessageBox.Show("Failed to get exclusive rights to the device."
					,"DisplaySample_9",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","DisplaySample_Step9",
					MessageBoxButtons.OK);
		...
		protected  void OnStatusUpdateEvent(object source, StatusUpdateEventArgs e)
        {
			...
			switch(e.Status)
			{
				...
				case PosCommon.StatusPowerOnline:
					MessageBox.Show("The device is powered on.","DisplaySample_Step9"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(true);
					break;
					//The device is powered off, or unconnected.
				case PosCommon.StatusPowerOff:
					MessageBox.Show("The device is powered off","DisplaySample_Step9"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(false);
					break;
				...
				case PosCommon.StatusPowerOffOffline:
					MessageBox.Show("The device is powered off or off-line.","DisplaySample_Step9"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(false);
					break;
				default:
