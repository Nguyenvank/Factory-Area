...
Public Class FrameStep14
    ...
    'Now Step.
    Private m_strStep As String = "PrinterSample_Step14"
...
#Region " Windows Forms Designer generated code."
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnPageMode
        '
        Me.btnPageMode.Location = New System.Drawing.Point(28, 104)
        ...
        'btnReceipt
        '
        Me.btnReceipt.Location = New System.Drawing.Point(28, 80)
        ...
        'btnAsync
        '
        Me.btnAsync.Location = New System.Drawing.Point(28, 56)
        ...
        Me.Name = "FrameStep14"
        Me.Text = "Step 14 Printing in PageMode"
...
InsertStart:
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub FrameStep14_Load(ByVal sender As System.Object _
    , ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strFilePath = strCurDir.Substring(0, strCurDir.IndexOf("Step14") + "Step14\".Length)
        ...
        Try
            ...
            If m_Printer.CapRecBitmap Then
                ...
                If Not bSetBitmapSuccess Then
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep14" _
                            , MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
            End If
            '<<<step3>>>--End
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub FrameStep14_Closing(ByVal sender As Object _
    ...
    Private Sub btnPageMode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPageMode.Click
        ...
        Dim nowDate As DateTime = DateTime.Now      'System date
        Dim dateFormat As New DateTimeFormatInfo    'Date Format
        ...
        Try
            ...
            If bBitmapPrint Then
                ...
                Dim strFilePath As String = Directory.GetCurrentDirectory().Substring(0, Directory.GetCurrentDirectory().LastIndexOf("Step14") + "Step14\".Length)
