...
namespace Inventory_Data
{
    public static class DBConnect
    {
        ...
        {
            myCon = new SqlConnection(clsData.getConnectionString());
            myCon.Open();
    ...
    public static class clsData
    {
        ...
        {
            string codeCheck = clsData.Left(packCode, 3);
            string codeType = clsData.Mid(packCode, 4, 3);
            string codeID = clsData.Right(packCode, 5);
        ...
        public static void fnDateTime(Label lbl,byte kind)
        {
            ...
            if(check.IsConnectedToInternet())
            {
                ...
                {
                    case 1:
                        lbl.Text = clsData.fnGetDate("SD");
                        break;
                    case 2:
                        lbl.Text = clsData.fnGetDate("CT");
                        break;
                    case 3:
                        lbl.Text = clsData.fnGetDate("SD") + " - " + clsData.fnGetDate("CT");
                        break;
                }
        ...
        public static void fnDateTime(Button btn, byte kind)
        {
            ...
            if (check.IsConnectedToInternet())
            {
                ...
                {
                    case 1:
                        btn.Text = clsData.fnGetDate("SD");
                        break;
                    case 2:
                        btn.Text = clsData.fnGetDate("CT");
                        break;
                    case 3:
                        btn.Text = clsData.fnGetDate("SD") + " - " + clsData.fnGetDate("CT");
                        break;
                }
            ...
            if (msg != "" && msg != null)
            {
                switch (type)
                {
                    ...
                    case 2:
                        ...
                        tssMessage.ForeColor = Color.Red;
                        break;
                    case 3:
                        // SQL ERRORS MESSAGE
                        tssMessage.ForeColor = Color.Tomato;
                        break;
                }
                tssMessage.Text = msg;
            }
        ...
        public static void fnSetDateTime(ToolStripStatusLabel tss)
        {
            if (check.IsConnectedToInternet())
            {
                tss.Text = clsData.fnGetDate("SD") + " - " + clsData.fnGetDate("CT");
        ...
        public static void fnCopyDatagridviewContent(DataGridView dgv, ToolStripStatusLabel tss)
        {
            ...
            clsData.fnMessage(tss, _msgText, _msgType);
        }
