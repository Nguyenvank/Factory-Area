    ...
    public partial class frmSub01CreateMaterial_HandOverPrint : Form
    {
        ...
        public void init(string hoIDx)
        {
            ...
            if (dsHead.Tables.Count > 0)
            {
                ...
                lblPrint_Code.Text = "Mã nhập: " + hoCode;
                lblPrint_Date.Text = "Ngày: " + hoDate;
                ...
                dgvPrint_List.Columns[0].Width = 40 * _dgvPrint_List_Width / 100;    // matName
                dgvPrint_List.Columns[1].Width = 35 * _dgvPrint_List_Width / 100;    // matCode
                dgvPrint_List.Columns[2].Width = 15 * _dgvPrint_List_Width / 100;    // matQty
                dgvPrint_List.Columns[3].Width = 10 * _dgvPrint_List_Width / 100;    // matUnit
                ...
                cls.fnFormatDatagridviewWhite(dgvPrint_List, 11, 30);
