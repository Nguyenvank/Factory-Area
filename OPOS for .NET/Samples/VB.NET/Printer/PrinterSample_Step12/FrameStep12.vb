...
Public Class FrameStep12
    ...
    'Now Step.
    Private m_strStep As String = "PrinterSample_Step12"
...
#Region " Windows Forms Designer generated code."
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnRecoverError
        '
        Me.btnRecoverError.Location = New System.Drawing.Point(24, 28)
        ...
        Me.Name = "FrameStep12"
        Me.Text = "Step 12 Rotated-Prints Bitmaps and Barcodes"
...
InsertStart:
    ...
    , ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strFilePath = strCurDir.Substring(0, strCurDir.IndexOf("Step12") + "Step12\".Length)
        ...
        Try
            ...
            If m_Printer.CapRecBitmap Then
                ...
                If Not bSetBitmapSuccess Then
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep12" _
                            , MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
            End If
            '<<<step3>>>--End
