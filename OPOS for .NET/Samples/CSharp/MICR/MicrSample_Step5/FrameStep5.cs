...
namespace MicrSample_Step5
{
	...
	public class FrameStep5 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmStep5";
			this.Text = "Step 5  Adding a function printing on the other side of the slip.";
				...
				catch(PosControlException pex)
				{
					...
					if (pex.ErrorCode == ErrorCode.Timeout) 
					{
						...
						dialogResult = MessageBox.Show("Please insert a check."
							,"MicrSample_Step5",MessageBoxButtons.YesNo);
		...
		private void btnRemove_Click(object sender, System.EventArgs e)
		{
			...
			catch(PosControlException pex)
			{
				...
				if (pex.ErrorCode == ErrorCode.Timeout) 
				{
					MessageBox.Show("Please remove a check.","MicrSample_Step5");
				}
			}
		}
		...
		private void frmStep5_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","MicrSample_Step5");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","MicrSample_Step5",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				MessageBox.Show("This device has not been registered, or cannot use."
					,"MicrSample_Step5",MessageBoxButtons.OK);
			...
			{
				//Failed CreateInstance
				MessageBox.Show("Failed to create instance","MicrSample_Step5"
			...
			{
				MessageBox.Show("Now the device is disable to use.","MicrSample_Step5"
					,MessageBoxButtons.OK);
		...
		protected void OnErrorEvent(object source, DeviceErrorEventArgs e )
        {
			...
			MessageBox.Show("Micr Error\n" + "ErrorCode =" + e.ErrorCode.ToString() + "\n"
				+ "ErrorCodeExtended =" +e.ErrorCodeExtended.ToString() ,"MicrSample_Step5"
				,MessageBoxButtons.OK);
			//<<<step4>>>--End
		}
		...
		protected void OnStatusUpdateEvent(object source, StatusUpdateEventArgs e)
        {
			...
			switch(e.Status)
			{
				...
				case PosCommon.StatusPowerOnline:
					MessageBox.Show("The device is powered on.","MicrSample_Step5"
						,MessageBoxButtons.OK);
					break;
					//The device is powered off, or unconnected.
				case PosCommon.StatusPowerOff:
					MessageBox.Show("The device is powered off","MicrSample_Step5"
						,MessageBoxButtons.OK);
					break;
