...
Public Class FrameStep8
    ...
    'Now Step.
    Private m_strStep As String = "PrinterSample_Step8"
...
#Region " Windows Forms Designer generated code."
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrameStep8"
        Me.Text = "Step 8  Rotate printing"
...
#End Region
    ...
    , ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strFilePath = strCurDir.Substring(0, strCurDir.IndexOf("Step8") + "Step8\".Length)
        ...
        Try
            ...
            If m_Printer.CapRecBitmap Then
                ...
                If Not bSetBitmapSuccess Then
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep8" _
