...
{
    public partial class frmDeliveryStatus_v3o2_AutoRefresh : Form
    {
        public int _dgvDelivery_List_Width;

        public DateTime _dt;

        public frmDeliveryStatus_v3o2_AutoRefresh()
        {
            InitializeComponent();
        }

        private void frmDeliveryStatus_v3o2_AutoRefresh_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        public void Fnc_Load_Delivery()
        {
            //DateTime deliveryDate = dtpDelivery_Date.Value;
            DateTime deliveryDate = _dt;
