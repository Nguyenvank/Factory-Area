...
namespace Inventory_Data
{
    public partial class frmPM_00LoginSystem : Form
    {
        ...
        private void frmPM_00LoginSystem_Load(object sender, EventArgs e)
        {
            try
            {
                //txtUsn.Text = "tran trung dung";
                //txtPwd.Text = "abc!123123";
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (usn.Length > 0 && pwd.Length > 0)
                {
                    ...
                    string sql = "PMMS_00_Login_To_System_SelItem_V1o1_Addnew";
                    ...
                    if (ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            {
                                case 1:
                                    frmPM_01WorkOrders frmWorkOrder = new frmPM_01WorkOrders(_logIDx, _logLevel, logName, _logDept);
