...
namespace PrinterSample_Step8
{
	...
	public class FrameStep8 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.grpReceipt.Size = new System.Drawing.Size(276, 168);
			...
			// btnReceipt
			// 
			this.btnReceipt.Location = new System.Drawing.Point(68, 116);
			...
			// btnClose
			// 
			this.btnClose.Location = new System.Drawing.Point(180, 220);
			...
			this.Name = "frmStep8";
			this.Text = "Step 8  Rotate printing";
		...
		private void frmStep8_Load(object sender, System.EventArgs e)
		{
			...
			string strFilePath = strCurDir.Substring(0,strCurDir.LastIndexOf("Step8") + "Step8\\".Length);
			...
			try
			{
                ...
                if (m_Printer.CapRecBitmap == true)
                {
                    ...
                    {
                        MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep8"
