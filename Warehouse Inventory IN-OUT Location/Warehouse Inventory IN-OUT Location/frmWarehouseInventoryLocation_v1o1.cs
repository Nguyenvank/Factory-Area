...
{
    public partial class frmWarehouseInventoryLocation_v1o1 : Form
    {
        public DateTime _dt;
        ...
        public frmWarehouseInventoryLocation_v1o1()
        {
            InitializeComponent();
            ...
            flowLayoutPanel1.ContextMenu = mnuPanel;

            cls.SetDoubleBuffer(flowLayoutPanel1, true);
        }
        ...
        public void init()
        {
            ...
            //fnTabs(warehouseIDx, _warehouseIDx);
            fnTabsRack(warehouseIDx, _warehouseIDx, _locateChar[0]);
        }
        ...
        public void timerLocate_Tick(object sender, EventArgs e)
        {
            try
            {
                if (_locateChar.Length > 0)
                {
                    ...
                    fnTabsRack(warehouseIDx, _warehouseIDx, _locateChar[_currLetterIDx]);
                }
                else
                {
        ...
        public void fnTabs(string locIDx, int tab)
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    lbl_1_header_1.Size = new System.Drawing.Size(btnWidth, Convert.ToInt32(20 * 100 / btnHeight));
                    ...
                    lbl_1_code_1.Size = new System.Drawing.Size(btnWidth, Convert.ToInt32(20 * 100 / btnHeight));
                    ...
                    lbl_1_quantity_1.Size = new System.Drawing.Size(btnWidth, Convert.ToInt32(40 * 100 / btnHeight));
                    ...
                    lbl_1_date_1.Size = new System.Drawing.Size(btnWidth, Convert.ToInt32(20 * 100 / btnHeight));
        ...
        public void fnTabsRack(string locIDx, int tab, string rackLetter)
        {
