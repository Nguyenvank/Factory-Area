...
{
    public partial class uc_MNT_SpareScanOut_PrintBill_v1o1 : Form
    {
        public string _orderIDx = "";
        public int _dgv_Print_ScanOut_List_Width;

        public uc_MNT_SpareScanOut_PrintBill_v1o1(string orderIDx)
        {
            InitializeComponent();
            _orderIDx = orderIDx;
        ...
        private void uc_MNT_SpareScanOut_PrintBill_v1o1_Load(object sender, EventArgs e)
        {
        ...
        private void uc_MNT_SpareScanOut_PrintBill_v1o1_KeyDown(object sender, KeyEventArgs e)
        {
