...
{
    public partial class uc_MMS_WarehouseMaterialScanOut_v1o0 : UserControl
    {
        ...
        public uc_MMS_WarehouseMaterialScanOut_v1o0()
        {
            InitializeComponent();
        }

        private void uc_MMS_WarehouseMaterialScanOut_v1o0_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (packType == "MMT")
                    {
                        ...
                        if (dsExist.Tables.Count > 0 && dsExist.Tables[0].Rows.Count > 0)
                        {
                            ...
                            {
                                int msgType = 2;    /* 1- MessageBox with OK; 2- MessageBox with YESNO */
                        ...
                        else
                        {
                            ...
                            lblMessage.Text = "Sai vật tư như yêu cầu. Vui lòng kiểm tra vật tư đang được chọn và scan lại.";
                        }
                    }
                    else
                    {
