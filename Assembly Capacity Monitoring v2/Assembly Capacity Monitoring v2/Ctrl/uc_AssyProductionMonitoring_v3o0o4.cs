...
{
    public partial class uc_AssyProductionMonitoring_v3o0o4 : UserControl
    {
        ...
        public uc_AssyProductionMonitoring_v3o0o4()
        {
            InitializeComponent();
        ...
        private void uc_AssyProductionMonitoring_v3o0o4_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        {
            lbl_Title.Text = "ASSEMBLY ONLINE OPERATOR EFFICIENCY MONITORING SYSTEM       " + cls.Left(cls.fnGetDate("dt"), 16);
        }
