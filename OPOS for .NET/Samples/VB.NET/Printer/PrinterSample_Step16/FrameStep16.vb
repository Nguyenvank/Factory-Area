...
Public Class FrameStep16
    ...
    'Now Step.
    Private m_strStep As String = "PrinterSample_Step16"
    ...
    Friend WithEvents btnMultiTone As System.Windows.Forms.Button
...
#Region " Windows Forms Designer generated code."
    ...
    Friend WithEvents btnPageMode As System.Windows.Forms.Button
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnPageMode = New System.Windows.Forms.Button
        ...
        Me.btnMultiTone = New System.Windows.Forms.Button
        ...
        'btnPrint
        '
        Me.btnPrint.Location = New System.Drawing.Point(28, 19)
        ...
        'grpReceipt
        '
        Me.grpReceipt.Controls.Add(Me.btnMultiTone)
        Me.grpReceipt.Controls.Add(Me.btnPageMode)
        ...
        Me.grpReceipt.Size = New System.Drawing.Size(196, 154)
        ...
        'btnPageMode
        '
        Me.btnPageMode.Location = New System.Drawing.Point(28, 94)
        Me.btnPageMode.Name = "btnPageMode"
        Me.btnPageMode.Size = New System.Drawing.Size(144, 24)
        Me.btnPageMode.TabIndex = 3
        Me.btnPageMode.Text = "Ticket Coupon Printing"
        '
        'btnReceipt
        '
        Me.btnReceipt.Location = New System.Drawing.Point(28, 69)
        ...
        'btnAsync
        '
        Me.btnAsync.Location = New System.Drawing.Point(28, 44)
        ...
        'btnClose
        '
        Me.btnClose.Location = New System.Drawing.Point(352, 328)
        ...
        Me.btnSales.Text = "Print Sales Slip"
        '
        'grpDirectIO
        '
        ...
        Me.grpRecoverError.Size = New System.Drawing.Size(188, 72)
        ...
        'btnRecoverError
        '
        Me.btnRecoverError.Location = New System.Drawing.Point(20, 28)
        Me.btnRecoverError.Name = "btnRecoverError"
        Me.btnRecoverError.Size = New System.Drawing.Size(140, 24)
        ...
        Me.grpStatistics.Location = New System.Drawing.Point(28, 272)
        Me.grpStatistics.Name = "grpStatistics"
        Me.grpStatistics.Size = New System.Drawing.Size(192, 84)
        Me.grpStatistics.TabIndex = 5
        Me.grpStatistics.TabStop = False
        Me.grpStatistics.Text = "Device Statistics"
        '
        'btnRetrieveStatistics
        '
        Me.btnRetrieveStatistics.Location = New System.Drawing.Point(24, 48)
        Me.btnRetrieveStatistics.Name = "btnRetrieveStatistics"
        Me.btnRetrieveStatistics.Size = New System.Drawing.Size(148, 24)
        Me.btnRetrieveStatistics.TabIndex = 4
        Me.btnRetrieveStatistics.Text = "Retrieve Statistics"
        '
        'txtStatistics
        '
        Me.txtStatistics.Location = New System.Drawing.Point(24, 24)
        Me.txtStatistics.Name = "txtStatistics"
        Me.txtStatistics.Size = New System.Drawing.Size(148, 19)
        Me.txtStatistics.TabIndex = 0
        Me.txtStatistics.Text = "ModelName,HoursPoweredCount,ReceiptCharacterPrintedCount"
        '
        'btnMultiTone
        '
        Me.btnMultiTone.Location = New System.Drawing.Point(28, 119)
        Me.btnMultiTone.Name = "btnMultiTone"
        Me.btnMultiTone.Size = New System.Drawing.Size(144, 23)
        Me.btnMultiTone.TabIndex = 4
        Me.btnMultiTone.Text = "Multi-tone Print"
        Me.btnMultiTone.UseVisualStyleBackColor = True
        '
        'FrameStep16
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 12)
        Me.ClientSize = New System.Drawing.Size(468, 377)
        ...
        Me.Name = "FrameStep16"
        Me.Text = "Step 16 Printing in Multi-tone"
...
InsertStart:
    ...
    , ByVal e As System.EventArgs) Handles btnReceipt.Click
        ...
        Dim dateFormat As DateTimeFormatInfo = New DateTimeFormatInfo
        Dim strDate As String
        Dim strbcData As String = "4902720005074"
        Dim iRecLineSpacing As Integer
        Dim iRecLineHeight As Integer
        Dim bBuffering As Boolean
        Dim iPrintRotation As Integer
        Dim arBitmapRotationList() As Rotation
        Dim arBarcodeRotationList() As Rotation
        Dim bBitmapPrint As Boolean = False
        Dim bBarcodePrint As Boolean = False
        Dim strCurDir As String = Directory.GetCurrentDirectory()
        Dim dialogResult As DialogResult

        Dim strFilePath As String = strCurDir.Substring(0, strCurDir.LastIndexOf("bin"))
        bBuffering = True
        ...
        '<<<step12>>>--Start
        arBitmapRotationList = m_Printer.RecBitmapRotationList
        arBarcodeRotationList = m_Printer.RecBarCodeRotationList

        'Check rotate bitmap
        For i As Integer = 0 To arBitmapRotationList.Length - 1

            If arBitmapRotationList(i).Equals(Rotation.Left90) Then

                bBitmapPrint = True
                iPrintRotation = (iPrintRotation Or PrintRotation.Left90) Or (PrintRotation.Bitmap)

            End If
        Next

        For i As Integer = 0 To arBarcodeRotationList.Length - 1

            If arBarcodeRotationList(i).Equals(Rotation.Left90) Then

                bBarcodePrint = True
                iPrintRotation = (iPrintRotation Or PrintRotation.Left90) Or (PrintRotation.Barcode)
        ...
        If m_Printer.CapRecPresent Then
            ...
            Do
                ...
                Try
                    ...
                    m_Printer.RotatePrint(PrinterStation.Receipt _
                    , iPrintRotation)

                    '<<<step12>>>--Start
                    If bBitmapPrint = True Then

                        m_Printer.PrintBitmap(PrinterStation.Receipt, strFilePath, _
                        m_Printer.RecLineWidth / 6 _
                    ...
                    m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|1C")
                    ...
                    m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|uC" _
                        + " Tax(5%)        $1.00" + ESC + "|N" + "    Phone#(9999)99-9998" + vbCrLf + vbCrLf)

                    '<<<step12>>>--Start
                    If bBarcodePrint = True Then
                        m_Printer.PrintBarCode(PrinterStation.Receipt, _
                        strbcData, BarCodeSymbology.EanJan13, _
                        500, m_Printer.RecLineWidth / 2, 1, _
                        BarCodeTextPosition.Below)
                    End If
                    '<<<step12>>>--End
                ...
                Catch ex As PosControlException
                    ...
                    If ex.ErrorCode = ErrorCode.Illegal And ex.ErrorCodeExtended = 1004 Then
                        ...
                        MessageBox.Show("Failes to receipt printing." + vbCrLf + GetErrorCode(ex) _
                    ...
                    If dialogResult = dialogResult.Abort Or dialogResult = dialogResult.Ignore Then
        ...
        Else
            ...
            MessageBox.Show("Cannot use a Receipt Station.", m_strStep _
            , MessageBoxButtons.OK, MessageBoxIcon.Warning)
        ...
        Catch ex As Exception
            ...
            ' Clear the buffered data since the buffer retains print data when an error occurs during printing.
            m_Printer.ClearOutput()
            MessageBox.Show("Failes to receipt printing." + vbCrLf + GetErrorCode(ex), m_strStep, _
             MessageBoxButtons.OK, MessageBoxIcon.Warning)
    ...
    , ByVal e As System.EventArgs) Handles btnSales.Click
        ...
        Dim dateFormat As DateTimeFormatInfo = New DateTimeFormatInfo    'Date Foramt
        dateFormat.MonthDayPattern = "MMMM"
        ...
        Dim bValidFlag As Boolean = False
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub FrameStep16_Load(ByVal sender As System.Object _
    , ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strFilePath = strCurDir.Substring(0, strCurDir.IndexOf("Step16") + "Step16\".Length)
        ...
        Try
            ...
            If m_Printer.CapRecBitmap Then
                ...
                If Not bSetBitmapSuccess Then
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep16" _
                            , MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
            End If
            '<<<strep3>>>--End
        ...
        '<<<step13>>>--Start
        If m_Printer.CapStatisticsReporting = False Then
        ...
        '        If (m_Printer.CapRecPageMode = False) Then
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub FrameStep16_Closing(ByVal sender As Object _
    , ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ...
        Try
            ...
            '<<<step10>>>--Start
            'Remove ErrorEventHnadler.
            RemoveErrorEvent(m_Printer)
            '<<<step10>>>--End

            '<<<step10>>>--Start
            'Remove StatusUpdateEventHnadler.
    ...
    Private Sub btnPageMode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPageMode.Click

        Dim nowDate As DateTime = DateTime.Now      'System date
        Dim dateFormat As New DateTimeFormatInfo    'Date Foramt
        dateFormat.MonthDayPattern = "MM"
        Dim strDate As String = nowDate.ToString("yyyy,MM,dd HH:mm:ss", dateFormat)

        Dim strbcData As String = "4902720005074"
        Dim ESC As String = Chr(&H1B)

        Dim iPMDescriptorList() As Integer = {CInt(PageModeDescriptors.BitmapRotate), CInt(PageModeDescriptors.BarcodeRotate), CInt(PageModeDescriptors.Opaque)}

        Dim bBitmapPrint As Boolean = False
        Dim bBarcodePrint As Boolean = False
        Dim iCount As Integer = 0
        Dim iGetPMDescriptor As Integer
        Dim iVPosition As Integer
        Dim strPropData As String = ""
        'string /*strPMArea strMaxHArea, strMaxVArea*/ strSetVPosition;
        Dim rectPMArea As Rectangle
        Dim iMaxHArea, iMaxVArea, iSetVPosition As Integer
        Dim strExpiration As String
        'string[] strMaxHVArea;
        Dim strTime As String() = strDate.Split(New [Char]() {","c})



        Try
            If m_Printer.CapRecPresent = False Then
                MessageBox.Show("Cannot use a Receipt Station.", m_strStep, MessageBoxButtons.OK, MessageBoxIcon.Warning)

                Return
            End If
            m_Printer.PageModeStation = PrinterStation.Receipt

            iGetPMDescriptor = CInt(m_Printer.PageModeDescriptor)

            ' Select of target station of PageMode
            For iCount = 2 To 0 Step -1
                If iPMDescriptorList(iCount) <= iGetPMDescriptor Then
                    iGetPMDescriptor = iGetPMDescriptor - iPMDescriptorList(iCount)
                    Select Case iCount

                        Case 0
                            If m_Printer.CapRecBitmap Then
                                Dim iMax As Integer = m_Printer.RecBitmapRotationList.Length
                                Dim icounter As Integer
                                For icounter = 0 To iMax - 1
                                    If (m_Printer.RecBitmapRotationList(icounter) = Rotation.Right90) Then
                                        bBitmapPrint = True
                                        Exit For
                                    End If
                                Next
                        ...
                        Case 1
                            If m_Printer.CapRecBarCode Then
                                Dim iMax As Integer = m_Printer.RecBarCodeRotationList.Length
                                Dim icounter As Integer
                                For icounter = 0 To iMax - 1
                                    If (m_Printer.RecBarCodeRotationList(icounter) = Rotation.Right90) Then
                                        bBarcodePrint = True
                                        Exit For
                                    End If
                                Next
            ...
            Dim strOutputData As String = "OPOS.NET Store"
            ...
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|4C" + ESC + "|cA" + ESC + "|2uC" + strOutputData + vbCrLf)

            ' Right90
            iVPosition = iMaxVArea
            If iVPosition > 12000 Then
            ...
            'm_Printer.PageModePrintArea = strPMArea;
            m_Printer.PageModePrintArea = rectPMArea
            ...
            If bBitmapPrint Then
                ...
                Dim strFilePath As String = Directory.GetCurrentDirectory().Substring(0, Directory.GetCurrentDirectory().LastIndexOf("Step16") + "Step16\".Length)

                strFilePath = strFilePath + "Logo.bmp"
            ...
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|4CCoupon ticket" + vbCrLf)
            m_Printer.PageModeVerticalPosition = 0
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|rA123xxStreet,xxCity,xxState" + vbCrLf)
            m_Printer.PageModeVerticalPosition = m_Printer.RecLineSpacing
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|rATEL 9999-99-9999" + vbCrLf)
            m_Printer.PageModeVerticalPosition = m_Printer.RecLineSpacing * 2
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|rA" + strDate + vbCrLf)

            m_Printer.PageModeHorizontalPosition = 0
            iVPosition = m_Printer.RecLineWidth / 4 ' a criterion value of Vertical position
            m_Printer.PageModeVerticalPosition = iVPosition
            m_Printer.PrintNormal(PrinterStation.Receipt, "The following amount will be deducted " + vbCrLf + "from your total sales at the register " + vbCrLf + "by showing us this coupon." + vbCrLf)
            ...
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|bCper coupon" + vbCrLf)

            m_Printer.PageModeHorizontalPosition = 0
            m_Printer.PageModeVerticalPosition = iVPosition + m_Printer.RecLineSpacing * 4
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|2uC                                    " + vbCrLf)

            m_Printer.PageModeVerticalPosition = iVPosition + m_Printer.RecLineSpacing * 5
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|4C" + ESC + "|2uC      $1.00  OFF  " + vbCrLf)
            ...
            For iCount = 1 To strTime.Length - 1
                strExpiration = strExpiration + strTime(iCount)
            Next iCount
            m_Printer.PrintNormal(PrinterStation.Receipt, ESC + "|bCExpiration Date : " + strDate + vbCrLf)

            ' Printing Barcode
            If bBarcodePrint Then
                m_Printer.PageModeHorizontalPosition = 0
                m_Printer.PageModeVerticalPosition = m_Printer.RecLineSpacing * 5
                m_Printer.PrintBarCode(PrinterStation.Receipt, strbcData, BarCodeSymbology.EanJan13, 1000, m_Printer.RecLineWidth / 3, PosPrinter.PrinterBitmapRight, BarCodeTextPosition.Below)
            End If
            ...
            Catch
            End Try
        Catch pex As PosControlException
            MessageBox.Show("Cannot use a POS Printer." + vbCrLf + GetErrorCode(pex), "Printed receipt", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End Try
    End Sub 'btnPageMode_Click 


    Private Sub btnMultiTone_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMultiTone.Click
        '<<<step16>>>--Start
        Dim iData As Integer = 0
        Dim abyte() As Byte = {0}
        Dim nowDate As DateTime = DateTime.Now      'System date
