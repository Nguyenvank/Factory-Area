...
namespace Inventory_Data
{
    ...
    public static class cls
    {
        ...
        public static string GenerateQRCode(string name)
        {
            string _filepath = "";
            //var writer = new BarcodeWriter();
            //writer.Format = BarcodeFormat.QR_CODE;
            //var result = writer.Write(name);
            //string path = System.Web.HttpContext.Current.Server.MapPath("~/Images/QR.jpg");
        ...
        public static string ReadQRCode()
        {
            ...
            //string filename = Path.Combine(System.Web.HttpContext.Current.Request.MapPath("~/Images"), "QR.jpg");

            //// Detect and decode the barcode inside the bitmap
            //var result = reader.Decode(new Bitmap(filename));
            //code = (result != null) ? result.Text : "0";
            return code;
        }
