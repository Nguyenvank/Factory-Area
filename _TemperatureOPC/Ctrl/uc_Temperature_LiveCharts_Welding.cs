...
{
    public partial class uc_Temperature_LiveCharts_Welding : UserControl
    {
        private static uc_Temperature_LiveCharts_Welding _instance;
        public static uc_Temperature_LiveCharts_Welding Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new uc_Temperature_LiveCharts_Welding();
                return _instance;
            }
        }
        ...
        public ChartValues<MeasureModel> ChartValues17 { get; set; }
        public ChartValues<MeasureModel> ChartValues18 { get; set; }
        public System.Windows.Forms.Timer Timer { get; set; }
        //public Random Rand { get; set; }

        DateTime _dt;

        string mc01_sv, mc02_sv, mc03_sv, mc04_sv, mc05_sv, mc06_sv, mc07_sv, mc08_sv, mc09_sv, mc10_sv, mc11_sv, mc12_sv, mc13_sv, mc14_sv, mc15_sv, mc16_sv, mc17_sv, mc18_sv;
        string mc01_pv, mc02_pv, mc03_pv, mc04_pv, mc05_pv, mc06_pv, mc07_pv, mc08_pv, mc09_pv, mc10_pv, mc11_pv, mc12_pv, mc13_pv, mc14_pv, mc15_pv, mc16_pv, mc17_pv, mc18_pv;
        string mc01_al, mc02_al, mc03_al, mc04_al, mc05_al, mc06_al, mc07_al, mc08_al, mc09_al, mc10_al, mc11_al, mc12_al, mc13_al, mc14_al, mc15_al, mc16_al, mc17_al, mc18_al;
        ...
        double _mc01_sv = 0, _mc02_sv = 0, _mc03_sv = 0, _mc04_sv = 0, _mc05_sv = 0, _mc06_sv = 0, _mc07_sv = 0, _mc08_sv = 0, _mc09_sv = 0, _mc10_sv = 0, _mc11_sv = 0, _mc12_sv = 0, _mc13_sv = 0, _mc14_sv = 0, _mc15_sv = 0, _mc16_sv = 0, _mc17_sv = 0, _mc18_sv = 0;
        double _mc01_pv = 0, _mc02_pv = 0, _mc03_pv = 0, _mc04_pv = 0, _mc05_pv = 0, _mc06_pv = 0, _mc07_pv = 0, _mc08_pv = 0, _mc09_pv = 0, _mc10_pv = 0, _mc11_pv = 0, _mc12_pv = 0, _mc13_pv = 0, _mc14_pv = 0, _mc15_pv = 0, _mc16_pv = 0, _mc17_pv = 0, _mc18_pv = 0;
        double _mc01_al = 0, _mc02_al = 0, _mc03_al = 0, _mc04_al = 0, _mc05_al = 0, _mc06_al = 0, _mc07_al = 0, _mc08_al = 0, _mc09_al = 0, _mc10_al = 0, _mc11_al = 0, _mc12_al = 0, _mc13_al = 0, _mc14_al = 0, _mc15_al = 0, _mc16_al = 0, _mc17_al = 0, _mc18_al = 0;

        int _line = 1;


        public uc_Temperature_LiveCharts_Welding()
        {
            InitializeComponent();
            ...
            init_Chart(cartesianChart17, ChartValues16, _mc17_sv);
            init_Chart(cartesianChart18, ChartValues16, _mc18_sv);
        }

        private void uc_Temperature_LiveCharts_Welding_Load(object sender, EventArgs e)
        {
            //init_Load_Data();
            fnLoadData();

            lbl_R01_SV.Text = "SV: " + _mc01_sv + "" + (char)176 + "C";
            lbl_R01_PV.Text = "PV: " + _mc01_pv + "" + (char)176 + "C";
            lbl_R02_SV.Text = "SV: " + _mc02_sv + "" + (char)176 + "C";
            lbl_R02_PV.Text = "PV: " + _mc02_pv + "" + (char)176 + "C";
            lbl_R03_SV.Text = "SV: " + _mc03_sv + "" + (char)176 + "C";
            lbl_R03_PV.Text = "PV: " + _mc03_pv + "" + (char)176 + "C";
            lbl_R04_SV.Text = "SV: " + _mc04_sv + "" + (char)176 + "C";
            lbl_R04_PV.Text = "PV: " + _mc04_pv + "" + (char)176 + "C";
            ...
            lbl_R07_SV.Text = "SV: " + _mc07_sv + "" + (char)176 + "C";
            lbl_R07_PV.Text = "PV: " + _mc07_pv + "" + (char)176 + "C";
            lbl_R08_SV.Text = "SV: " + _mc08_sv + "" + (char)176 + "C";
            lbl_R08_PV.Text = "PV: " + _mc08_pv + "" + (char)176 + "C";
            lbl_R09_SV.Text = "SV: " + _mc09_sv + "" + (char)176 + "C";
            lbl_R09_PV.Text = "PV: " + _mc09_pv + "" + (char)176 + "C";
            lbl_R10_SV.Text = "SV: " + _mc10_sv + "" + (char)176 + "C";
            lbl_R10_PV.Text = "PV: " + _mc10_pv + "" + (char)176 + "C";
            lbl_R11_SV.Text = "SV: " + _mc11_sv + "" + (char)176 + "C";
            lbl_R11_PV.Text = "PV: " + _mc11_pv + "" + (char)176 + "C";
            lbl_R12_SV.Text = "SV: " + _mc12_sv + "" + (char)176 + "C";
            lbl_R12_PV.Text = "PV: " + _mc12_pv + "" + (char)176 + "C";
            lbl_R13_SV.Text = "SV: " + _mc13_sv + "" + (char)176 + "C";
            lbl_R13_PV.Text = "PV: " + _mc13_pv + "" + (char)176 + "C";
            lbl_R14_SV.Text = "SV: " + _mc14_sv + "" + (char)176 + "C";
            lbl_R14_PV.Text = "PV: " + _mc14_pv + "" + (char)176 + "C";
            lbl_R15_SV.Text = "SV: " + _mc15_sv + "" + (char)176 + "C";
            lbl_R15_PV.Text = "PV: " + _mc15_pv + "" + (char)176 + "C";
            lbl_R16_SV.Text = "SV: " + _mc16_sv + "" + (char)176 + "C";
            lbl_R16_PV.Text = "PV: " + _mc16_pv + "" + (char)176 + "C";
            lbl_R17_PV.Text = "PV: " + _mc17_pv + "" + (char)176 + "C";
            lbl_R18_PV.Text = "PV: " + _mc18_pv + "" + (char)176 + "C";
            ...
            lbl_R09_MM.Text = lbl_R10_MM.Text = lbl_R11_MM.Text = lbl_R12_MM.Text = minmax;
        ...
        public void init_Chart_Range(LiveCharts.WinForms.CartesianChart chart, double sv)
        {
            switch (chart.Name) {
            	case "cartesianChart01":
                    lbl_R01_MM.Text = (sv < 180.0) ? "SV " + (char)177 + " 5" + (char)176 + "C" : "SV +2/-1" + (char)176 + "C";
            		break;
            	case "cartesianChart02":
                    lbl_R02_MM.Text = (sv < 180.0) ? "SV " + (char)177 + " 5" + (char)176 + "C" : "SV +2/-1" + (char)176 + "C";
            		break;
            	case "cartesianChart03":
                    lbl_R03_MM.Text = (sv < 180.0) ? "SV " + (char)177 + " 5" + (char)176 + "C" : "SV +2/-1" + (char)176 + "C";
            		break;
            	case "cartesianChart04":
                    lbl_R04_MM.Text = (sv < 180.0) ? "SV " + (char)177 + " 5" + (char)176 + "C" : "SV +2/-1" + (char)176 + "C";
            		break;
            	...
            	case "cartesianChart11":
            		//lbl_R11_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
            		lbl_R11_MM.Text="SV " + (char)177 + " 5" + (char)176 + "C";
            		break;
            	case "cartesianChart12":
            		//lbl_R12_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
            		lbl_R12_MM.Text="SV " + (char)177 + " 5" + (char)176 + "C";
            		break;
            	case "cartesianChart13":
            		//lbl_R13_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
            		lbl_R13_MM.Text="SV " + (char)177 + " 5" + (char)176 + "C";
            		break;
            	case "cartesianChart14":
            		//lbl_R14_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
            		lbl_R14_MM.Text="SV " + (char)177 + " 5" + (char)176 + "C";
            		break;
            	case "cartesianChart15":
            		//lbl_R15_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
            		lbl_R15_MM.Text="SV " + (char)177 + " 5" + (char)176 + "C";
            		break;
            	case "cartesianChart16":
            		//lbl_R16_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
            		lbl_R16_MM.Text="SV " + (char)177 + " 5" + (char)176 + "C";
            		break;
                case "cartesianChart17":
                    //lbl_R17_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
                    lbl_R17_MM.Text = "SV " + (char)177 + " 5" + (char)176 + "C";
                    //lbl_R17_MM.Text = "215 ~ 245";
                    break;
                case "cartesianChart18":
                    //lbl_R18_MM.Text=(sv<180.0)?"SV " + (char)177 + " 5" + (char)176 + "C":"SV +2/-1"+(char)176+"C";
                    lbl_R18_MM.Text = "SV " + (char)177 + " 5" + (char)176 + "C";
                    //lbl_R18_MM.Text = "215 ~ 245";
                    break;
            }
        }
        ...
        private void TimerOnTick(object sender, EventArgs eventArgs, LiveCharts.WinForms.CartesianChart chart, ChartValues<MeasureModel> chartvalue,double sv)
        {
            ...
            switch (chart.Name)
            {
                ...
                case "cartesianChart17":
                    ...
                    lbl_R17_SV.Text = "SV: " + _mc17_sv + "" + (char)176 + "C";
                    lbl_R17_PV.Text = "PV: " + _mc17_pv + "" + (char)176 + "C";
                    break;
                case "cartesianChart18":
                    chartvalue.Add(new MeasureModel
                    ...
                    lbl_R18_SV.Text = "SV: " + _mc18_sv + "" + (char)176 + "C";
                    lbl_R18_PV.Text = "PV: " + _mc18_pv + "" + (char)176 + "C";
                    break;
            }
            //chartvalue.Add(new MeasureModel
        ...
        public void init_Data_InDay(LiveCharts.WinForms.CartesianChart chart, ChartValues<MeasureModel> chartvalue)
        {
            ...
            string sql = "V2o1_ERP_Temperature_Init_Data_SelItem_V1o1_Addnew";
        ...
        public void init_Data_MachineDay(LiveCharts.WinForms.CartesianChart chart, ChartValues<MeasureModel> chartvalue)
        {
            ...
            string sql = "V2o1_ERP_Temperature_Init_Machine_SelItem_V1o1_Addnew";
        ...
        //public void fnAddChartData(LiveCharts.WinForms.CartesianChart chart, double sv, double value, DateTime now)
        //{
        //    switch (machine)
        //    {
        //        case 1:
        //            ChartValues01.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart01, sv);
        //            break;
        //        case 2:
        //            ChartValues02.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart02, sv);
        //            break;
        //        case 3:
        //            ChartValues03.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart03, sv);
        //            break;
        //        case 4:
        //            ChartValues04.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart04, sv);
        //            break;
        //        case 5:
        //            ChartValues05.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart05, sv);
        //            break;
        //        case 6:
        //            ChartValues06.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart06, sv);
        //            break;
        //        case 7:
        //            ChartValues07.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart07, sv);
        //            break;
        //        case 8:
        //            ChartValues08.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart08, sv);
        //            break;
        //        case 9:
        //            ChartValues09.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart09, sv);
        //            break;
        //        case 10:
        //            ChartValues10.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart10, sv);
        //            break;
        //        case 11:
        //            ChartValues11.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart11, sv);
        //            break;
        //        case 12:
        //            ChartValues12.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart12, sv);
        //            break;
        //        case 13:
        //            ChartValues13.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart13, sv);
        //            break;
        //        case 14:
        //            ChartValues14.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart14, sv);
        //            break;
        //        case 15:
        //            ChartValues15.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart15, sv);
        //            break;
        //        case 16:
        //            ChartValues16.Add(new MeasureModel
        //            {
        //                DateTime = now,
        //                Value = value
        //            });
        //            SetAxisLimits(now, cartesianChart16, sv);
        //            break;
        //    }
        //}
        ...
        public void init_Load_Data()
        {
            try
            {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    mc17_sv = temp_SV.Substring(64, 4);
                    mc18_sv = temp_SV.Substring(72, 4);
                    ...
                    _mc17_sv = (mc17_sv != "0" && mc17_sv != null) ? Convert.ToDouble(mc17_sv) : 0;
                    _mc18_sv = (mc18_sv != "0" && mc18_sv != null) ? Convert.ToDouble(mc18_sv) : 0;
                    ...
                    mc17_pv = temp_PV.Substring(64, 4);
                    mc18_pv = temp_PV.Substring(72, 4);
                    ...
                    _mc01_pv = (mc01_pv != "0" && mc01_pv != null) ? Convert.ToDouble(mc01_pv) : 0;
                    _mc02_pv = (mc02_pv != "0" && mc02_pv != null) ? Convert.ToDouble(mc02_pv) : 0;
                    _mc03_pv = (mc03_pv != "0" && mc03_pv != null) ? Convert.ToDouble(mc03_pv) : 0;
                    _mc04_pv = (mc04_pv != "0" && mc04_pv != null) ? Convert.ToDouble(mc04_pv) : 0;
                    _mc05_pv = (mc05_pv != "0" && mc05_pv != null) ? Convert.ToDouble(mc05_pv) : 0;
                    _mc06_pv = (mc06_pv != "0" && mc06_pv != null) ? Convert.ToDouble(mc06_pv) : 0;
                    _mc07_pv = (mc07_pv != "0" && mc07_pv != null) ? Convert.ToDouble(mc07_pv) : 0;
                    _mc08_pv = (mc08_pv != "0" && mc08_pv != null) ? Convert.ToDouble(mc08_pv) : 0;
                    _mc09_pv = (mc09_pv != "0" && mc09_pv != null) ? Convert.ToDouble(mc09_pv) : 0;
                    _mc10_pv = (mc10_pv != "0" && mc10_pv != null) ? Convert.ToDouble(mc10_pv) : 0;
                    _mc11_pv = (mc11_pv != "0" && mc11_pv != null) ? Convert.ToDouble(mc11_pv) : 0;
                    _mc12_pv = (mc12_pv != "0" && mc12_pv != null) ? Convert.ToDouble(mc12_pv) : 0;
                    _mc13_pv = (mc13_pv != "0" && mc13_pv != null) ? Convert.ToDouble(mc13_pv) : 0;
                    _mc14_pv = (mc14_pv != "0" && mc14_pv != null) ? Convert.ToDouble(mc14_pv) : 0;
                    _mc15_pv = (mc15_pv != "0" && mc15_pv != null) ? Convert.ToDouble(mc15_pv) : 0;
                    _mc16_pv = (mc16_pv != "0" && mc16_pv != null) ? Convert.ToDouble(mc16_pv) : 0;
                    _mc17_pv = (mc17_pv != "0" && mc17_pv != null) ? Convert.ToDouble(mc17_pv) : 0;
                    _mc18_pv = (mc18_pv != "0" && mc18_pv != null) ? Convert.ToDouble(mc18_pv) : 0;
                    ...
                    mc17_al = temp_AL.Substring(64, 4);
                    mc18_al = temp_AL.Substring(72, 4);
                    ...
                    _mc17_al = (mc17_al != "0" && mc17_al != null) ? Convert.ToDouble(mc17_al) : 0;
                    _mc18_al = (mc18_al != "0" && mc18_al != null) ? Convert.ToDouble(mc18_al) : 0;
                    ...
                    lbl_R01_MC.BackColor = (_mc01_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R02_MC.BackColor = (_mc02_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R03_MC.BackColor = (_mc03_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R04_MC.BackColor = (_mc04_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R05_MC.BackColor = (_mc05_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R06_MC.BackColor = (_mc06_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R07_MC.BackColor = (_mc07_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R08_MC.BackColor = (_mc08_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R09_MC.BackColor = (_mc09_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R10_MC.BackColor = (_mc10_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R11_MC.BackColor = (_mc11_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R12_MC.BackColor = (_mc12_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R13_MC.BackColor = (_mc13_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R14_MC.BackColor = (_mc14_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R15_MC.BackColor = (_mc15_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R16_MC.BackColor = (_mc16_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R17_MC.BackColor = (_mc17_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
                    lbl_R18_MC.BackColor = (_mc18_al == 1) ? System.Drawing.Color.Red : System.Drawing.Color.FromKnownColor(KnownColor.Control);
