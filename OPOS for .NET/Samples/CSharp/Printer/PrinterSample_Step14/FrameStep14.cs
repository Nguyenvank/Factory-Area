...
namespace PrinterSample_Step14
{
	/// <summary>
	///  Description of FrameStep14.
	/// </summary>
	public class FrameStep14 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // btnPageMode
            // 
            this.btnPageMode.Location = new System.Drawing.Point(20, 152);
            ...
            // btnAsync
            // 
            this.btnAsync.Location = new System.Drawing.Point(20, 72);
            ...
            this.Name = "FrameStep14";
            this.Text = "Step 14  Printing in Page Mode";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.frmStep14_Closing);
            this.Load += new System.EventHandler(this.frmStep14_Load);
		...
		static void Main() 
		{
			Application.Run(new FrameStep14());
		}
			...
			try
			{
				if (m_Printer.CapRecPresent == true)
				{
					...
					{			
						...
						{
							MessageBox.Show("Cannot use a POS Printer.","Printer_SampleStep14"
						...
						catch(PosControlException)
						{
							...
							dialogResult = MessageBox.Show("Failed to output to printer.\n\nRetry?"
								,"Printer_SampleStep14",MessageBoxButtons.AbortRetryIgnore);
				...
				{
					MessageBox.Show("Cannot use a Receipt Stateion.","Printer_SampleStep14"
						,MessageBoxButtons.OK,MessageBoxIcon.Warning);
					return;
				}
			}
		...
		private void btnReceipt_Click(object sender, System.EventArgs e)
		{
			...
			string strFilePath = strCurDir.Substring(0,strCurDir.LastIndexOf("Step14") + "Step14\\".Length);
...
//			//----------------<end> When Validation is Used
		...
		private void btnSupportFunction_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("This function is disable to use.","PrinterSample_Step14");
			}
			//<<<step11>>--End
		}
		...
		private void btnPrintCode128_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("DirectIO Code128 failed.","PrinterSample_Step14");
		...
		private void btnPageMode_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					MessageBox.Show("Cannot use a Receipt Station.","Printer_SampleStep14"
						,MessageBoxButtons.OK,MessageBoxIcon.Warning);
				...
				if (bBitmapPrint)
				{
					string strFilePath = Directory.GetCurrentDirectory().Substring(0,Directory.GetCurrentDirectory().LastIndexOf("Step14") + "Step14\\".Length);
		...
		private bool WaitForInsertion()
		{
			...
			while(true)
			{
				...
				catch(PosControlException pex)
				{
					...
					{
						dialogResult =  MessageBox.Show("Please insert a form.","PrinterSample_Step14"
					...
					else
					{
						...
						MessageBox.Show(strMessage,"PrinterSample_Step14");
						bInsertion = false;
					}
				}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void frmStep14_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","PrinterSample_Step14");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			}
			...
			{
				MessageBox.Show("Failed to create instance.","PrinterSample_Step14");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			...
			{
				MessageBox.Show("Failed to open the device.","PrinterSample_Step14");
			...
			{
				MessageBox.Show("Failed to claim the device.","PrinterSample_Step14");
			...
			{
				MessageBox.Show("Disable to use the device.","PrinterSample_Step14");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			}
            ...
            if (m_Printer.CapRecBitmap == true)
            {
                ...
                {
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep14"
                            , MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
			//<<<step3>>>--End
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void frmStep14_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			//<<<step1>>>--Start
			if(m_Printer != null)
			{
		...
		protected  void OnErrorEvent(object source, DeviceErrorEventArgs e )
        {
			...
			dialogResult =  MessageBox.Show(strMessage,"PrinterSample_Step14"
