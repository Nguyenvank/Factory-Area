...
{
    public partial class frmAssyProductionMonitoring_v2o5 : Form
    {
        public frmAssyProductionMonitoring_v2o5()
        {
            InitializeComponent();
        }
        public int _dgvAssyMonitorWidth;

        private void frmAssyProductionMonitoring_v2o5_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void fnDataload()
        {
            try
            {
                ...
                string sql = "V2o1_BASE_Capacity_Work_Order_Monitor_2o3o5_Addnew";
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (dr[7].ToString() != null && dr[7].ToString() != "")
                    {
                        ...
                        string stop = dr[32].ToString();
                        dr[30] = (stop.ToLower() == "true") ? dr[31].ToString() : dr[30].ToString();
                ...
                dgvAssyMonitor.Columns[20].Width = 6 * _dgvAssyMonitorWidth / 100;    // [Seq]
                dgvAssyMonitor.Columns[21].Width = 6 * _dgvAssyMonitorWidth / 100;    // [Plan]
                ...
                dgvAssyMonitor.Columns[26].Width = 6 * _dgvAssyMonitorWidth / 100;    // [Goal]
                dgvAssyMonitor.Columns[27].Width = 6 * _dgvAssyMonitorWidth / 100;    // [Result]
                dgvAssyMonitor.Columns[28].Width = 6 * _dgvAssyMonitorWidth / 100;    // [Rate %]
                //dgvAssyMonitor.Columns[29].Width = 10 * _dgvAssyMonitorWidth / 100;   // [PicID]
                dgvAssyMonitor.Columns[30].Width = 20 * _dgvAssyMonitorWidth / 100;   // [PicName]
                //dgvAssyMonitor.Columns[31].Width = 10 * _dgvAssyMonitorWidth / 100;   // [Note]
                //dgvAssyMonitor.Columns[32].Width = 10 * _dgvAssyMonitorWidth / 100;   // [Stop]
                //dgvAssyMonitor.Columns[33].Width = 10 * _dgvAssyMonitorWidth / 100;   // [Active]
                //dgvAssyMonitor.Columns[34].Width = 10 * _dgvAssyMonitorWidth / 100;   // [Last Update]
                dgvAssyMonitor.Columns[35].Width = 4 * _dgvAssyMonitorWidth / 100;   // [ACT]
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dgvAssyMonitor.Rows)
                {
                    if (row.Cells[7].Value.ToString() != null && row.Cells[7].Value.ToString() != "")
                    {
                        ...
                        lastUpdate = row.Cells[34].Value.ToString();
                        active = row.Cells[33].Value.ToString();
                        ...
                        if (stop.ToLower() == "true")
                        {
                            ...
                            row.Cells[30].Style.ForeColor = Color.White;
                            ...
                            if (_lastUpdate < _dt && _orderShift == cls.fnGetDate("S").ToUpper())
                            {
                                ...
                                if (totalMinutes >= 5 && active == "1" && lineId != "15")
                                {
                                        ...
                                        )
                                    {
                                        ...
                                        row.Cells[35].Style.BackColor = Color.White;
                                    }
                                    else
                                    {
                                        row.Cells[25].Style.BackColor = Color.Firebrick;
                                ...
                                else
                                {
                                    if (active == "1")
                                    {
                                        row.Cells[35].Style.BackColor = Color.GreenYellow;
                                    }
                                    else
                                    {
