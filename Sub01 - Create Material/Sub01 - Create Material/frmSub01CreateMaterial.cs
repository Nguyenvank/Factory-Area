...
namespace Inventory_Data
{
    public partial class frmSub01CreateMaterial : Form
    {
        ...
        public frmSub01CreateMaterial()
        {
            ...
            cls.SetDoubleBuffer(dgvMaterial_LastUpdate, true);
        ...
        private void frmSub01CreateMaterial_Load(object sender, EventArgs e)
        {
            ...
            _dgvMaterial_LastUpdate_Width = cls.fnGetDataGridWidth(dgvMaterial_LastUpdate);
        ...
        #region MATERIAL LAST PURCHASE


        public void initMaterial_LastPurchase()
        {
            initMaterial_LastPurchase_List();
        }

        public void initMaterial_LastPurchase_List()
        {
            //string sql = "V2o1_BASE_SubMaterial_Init_BindingData_LastPurchase_SelItem_Addnew";
            string sql = "V2o1_BASE_SubMaterial_Init_BindingData_LastPurchase_SelItem_V2o1_Addnew";
            DataTable dt = new DataTable();
            dt = cls.fnSelect(sql);

            _dgvMaterial_LastUpdate_Width = cls.fnGetDataGridWidth(dgvMaterial_LastUpdate);
            dgvMaterial_LastUpdate.DataSource = dt;

            dgvMaterial_LastUpdate.Columns[0].Width = 5 * _dgvMaterial_LastUpdate_Width / 100;    // STT
            //dgvMaterial_LastUpdate.Columns[1].Width = 10 * _dgvMaterial_LastUpdate_Width / 100;    // ProdId
            dgvMaterial_LastUpdate.Columns[2].Width = 25 * _dgvMaterial_LastUpdate_Width / 100;    // Name
            dgvMaterial_LastUpdate.Columns[3].Width = 20 * _dgvMaterial_LastUpdate_Width / 100;    // BarCode
            //dgvMaterial_LastUpdate.Columns[4].Width = 13 * _dgvMaterial_LastUpdate_Width / 100;    // hoIDx
            dgvMaterial_LastUpdate.Columns[5].Width = 17 * _dgvMaterial_LastUpdate_Width / 100;    // hoCode
            dgvMaterial_LastUpdate.Columns[6].Width = 8 * _dgvMaterial_LastUpdate_Width / 100;    // Uom
            dgvMaterial_LastUpdate.Columns[7].Width = 10 * _dgvMaterial_LastUpdate_Width / 100;    // matQty
            dgvMaterial_LastUpdate.Columns[8].Width = 15 * _dgvMaterial_LastUpdate_Width / 100;    // hoDate

            dgvMaterial_LastUpdate.Columns[0].Visible = true;
            dgvMaterial_LastUpdate.Columns[1].Visible = false;
            dgvMaterial_LastUpdate.Columns[2].Visible = true;
            dgvMaterial_LastUpdate.Columns[3].Visible = true;
            dgvMaterial_LastUpdate.Columns[4].Visible = false;
            dgvMaterial_LastUpdate.Columns[5].Visible = true;
            dgvMaterial_LastUpdate.Columns[6].Visible = true;
            dgvMaterial_LastUpdate.Columns[7].Visible = true;
            dgvMaterial_LastUpdate.Columns[8].Visible = true;

            dgvMaterial_LastUpdate.Columns[8].DefaultCellStyle.Format = "dd/MM/yyyy HH:mm";
            cls.fnFormatDatagridviewWhite(dgvMaterial_LastUpdate, 12, 50);
            dgvMaterial_LastUpdate.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableWithAutoHeaderText;
        }

        private void dgvMaterial_LastUpdate_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {

        }

        private void dgvMaterial_LastUpdate_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex >= 0 && e.RowIndex >= 0)
            {
                cls.fnDatagridClickCell(dgvMaterial_LastUpdate, e);
                dgvMaterial_LastUpdate.ClearSelection();
            }
        }

        private void dgvMaterial_LastUpdate_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {

        }

        private void lnkMaterial_LastUpdate_Reload_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            initMaterial_LastPurchase_List();
        }

        private void lnkMaterial_LastUpdate_Copy_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            //if (dgvMaterial_LastUpdate.GetCellCount(DataGridViewElementStates.Selected) > 0)
            //{
            //    try
            //    {
            //        dgvMaterial_LastUpdate.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText;
            //        dgvMaterial_LastUpdate.SelectAll();
            //        Clipboard.SetDataObject(dgvMaterial_LastUpdate.GetClipboardContent());
            //    }
            //    catch
            //    {
            ...
            //if (dgvMaterial_LastUpdate.Rows.Count > 0)
            //{
            //    dgvMaterial_LastUpdate.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText;
            //    dgvMaterial_LastUpdate.SelectAll();
            //    Clipboard.SetDataObject(dgvMaterial_LastUpdate.GetClipboardContent());
            ...
            //}
            //cls.fnMessage(tssMsg, _msgText, _msgType);
            cls.fnCopyDatagridviewContent(dgvMaterial_LastUpdate, tssMsg);
        }
