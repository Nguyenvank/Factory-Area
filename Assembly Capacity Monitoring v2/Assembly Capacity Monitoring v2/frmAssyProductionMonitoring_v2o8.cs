...
{
    public partial class frmAssyProductionMonitoring_v2o8 : Form
    {
        ...
        public frmAssyProductionMonitoring_v2o8()
        {
            InitializeComponent();
        ...
        private void frmAssyProductionMonitoring_v2o7_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        public void init_Main()
        {
            try
            {
                //string sql = "V2o1_BASE_Capacity_Work_Order_Monitor_2o3o6_o3_Addnew";
                string sql = "V2o1_BASE_Capacity_Work_Order_Monitor_2o3o6_o3o1_Addnew";
                ...
                dgv_Main.Columns[27].Width = 9 * _dgv_Main_Width / 100;     //[Reason]
                //dgv_Main.Columns[28].Width = 3 * _dgv_Main_Width / 100;   //[PicID]
                dgv_Main.Columns[29].Width = 9 * _dgv_Main_Width / 100;     //[PIC]

                //dgv_Main.Columns[30].Width = 3 * _dgv_Main_Width / 100;   //[Active]
                //dgv_Main.Columns[31].Width = 3 * _dgv_Main_Width / 100;   //[Last Update]

                if (dgv_Main.ColumnCount > 37) { dgv_Main.Columns.Remove(imageCol); }
                _dgv_Main_Width = cls.fnGetDataGridWidth(dgv_Main);
                dgv_Main.Columns.Insert(32, imageCol);
                imageCol.Width = 3 * _dgv_Main_Width / 100;                 //Machine status image

                dgv_Main.Columns[33].Width = 2 * _dgv_Main_Width / 100;     //[F]
                dgv_Main.Columns[34].Width = 2 * _dgv_Main_Width / 100;     //[M]
                dgv_Main.Columns[35].Width = 2 * _dgv_Main_Width / 100;     //[L]
                //dgv_Main.Columns[36].Width = 3 * _dgv_Main_Width / 100;   //[TimeOut]
                dgv_Main.Columns[37].Width = 9 * _dgv_Main_Width / 100;   //[TimeOut]
                ...
                //dgv_Main.DefaultCellStyle.Font = new Font("Times new roman", 11, FontStyle.Bold);
                dgv_Main.DefaultCellStyle.Font = new Font("Tahoma", 11, FontStyle.Bold);
        ...
        public void fnc_dgvMain_Columns_Order()
        {
            ...
            dgv_Main.Columns[35].Visible = true;
            dgv_Main.Columns[36].Visible = false;
            dgv_Main.Columns[37].Visible = true;
            ...
            dgv_Main.Columns[37].DisplayIndex = 9;
            dgv_Main.Columns[29].DisplayIndex = 10;
            dgv_Main.Columns[32].DisplayIndex = 11;
            dgv_Main.Columns[33].DisplayIndex = 12;
            dgv_Main.Columns[34].DisplayIndex = 13;
            dgv_Main.Columns[35].DisplayIndex = 14;
