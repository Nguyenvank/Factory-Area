...
#Region " Windows Forms Designer generated code."
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grpReceipt.Size = New System.Drawing.Size(368, 96)
        ...
        'btnClose
        '
        Me.btnClose.Location = New System.Drawing.Point(308, 140)
        ...
        Me.Name = "FrameStep5"
        Me.Text = "Step 5  Writing a module that is independent of device types"
...
#End Region
    ...
    ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strFilePath = strCurDir.Substring(0, strCurDir.IndexOf("Step5") + "Step5\".Length)
        ...
        Try
            ...
            If m_Printer.CapRecBitmap Then
                ...
                If Not bSetBitmapSuccess Then
                    MessageBox.Show("Failed to set bitmap.", "Printer_SampleStep5" _
