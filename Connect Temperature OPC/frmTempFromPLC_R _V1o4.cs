...
namespace Fan_1
{
    public partial class frmTempFromPLC_R_V1o4 : Form
    {
        public int run = 1;
        ...
        string _R01_SV, _R02_SV, _R03_SV, _R04_SV, _R05_SV, _R06_SV, _R07_SV, _R08_SV, _R09_SV, _R10_SV, _R11_SV, _R12_SV, _R13_SV, _R14_SV, _R15_SV, _R16_SV, _R17_SV, _R18_SV, _R19_SV, _R20_SV;
        string _R01_PV, _R02_PV, _R03_PV, _R04_PV, _R05_PV, _R06_PV, _R07_PV, _R08_PV, _R09_PV, _R10_PV, _R11_PV, _R12_PV, _R13_PV, _R14_PV, _R15_PV, _R16_PV, _R17_PV, _R18_PV, _R19_PV, _R20_PV;
        ...
        public frmTempFromPLC_R_V1o4()
        {
            InitializeComponent();

            prg_DT.Value = prg_DT.Minimum = prg_DT.Maximum = 0;
        }

        private void frmTempFromPLC_R_V1o4_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;

            prg_DT.Minimum = 0;
            prg_DT.Maximum = 59;
            prg_DT.ForeColor = prg_DT.BackColor = Color.DodgerBlue;
        ...
        public void fnConnect()
        {
            try
            {
                ...
                OPCItemIDs.SetValue("Channel1.Device2.SV/RUBBER 19", 67);
                ClientHandles.SetValue(67, 67);
                OPCItemIDs.SetValue("Channel1.Device2.PV/RUBBER 19", 68);
                ClientHandles.SetValue(68, 68);
                OPCItemIDs.SetValue("Channel1.Device2.ALRM/RUBBER 19", 69);
                ClientHandles.SetValue(69, 69);

                OPCItemIDs.SetValue("Channel1.Device2.SV/RUBBER 20", 70);
                ClientHandles.SetValue(70, 70);
                OPCItemIDs.SetValue("Channel1.Device2.PV/RUBBER 20", 71);
                ClientHandles.SetValue(71, 71);
                OPCItemIDs.SetValue("Channel1.Device2.ALRM/RUBBER 20", 72);
        ...
        private void ObjOPCGroup_DataChange(int TransactionID, int NumItems, ref Array ClientHandles, ref Array ItemValues, ref Array Qualities, ref Array TimeStamps)
        {
            for (int i = 1; i <= NumItems; i++)
            {
                ...
                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 67) { lbl_R19_SV.Text = ItemValues.GetValue(i).ToString(); }      //SV
                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 68) { lbl_R19_PV.Text = ItemValues.GetValue(i).ToString(); }      //PV
                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 69) { lbl_R19_AL.Text = (Convert.ToBoolean(ItemValues.GetValue(i)) == true) ? "1" : "0"; int tempPV_R19 = Convert.ToInt32(lbl_R19_AL.Text); lbl_R19_AL.BackColor = (tempPV_R19 == 0) ? Color.LightGreen : Color.Pink; }  //AL

                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 70) { lbl_R20_SV.Text = ItemValues.GetValue(i).ToString(); }      //SV
                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 71) { lbl_R20_PV.Text = ItemValues.GetValue(i).ToString(); }      //PV
                if (Convert.ToInt32(ClientHandles.GetValue(i)) == 72) { lbl_R20_AL.Text = (Convert.ToBoolean(ItemValues.GetValue(i)) == true) ? "1" : "0"; int tempPV_R20 = Convert.ToInt32(lbl_R20_AL.Text); lbl_R20_AL.BackColor = (tempPV_R20 == 0) ? Color.LightGreen : Color.Pink; }  //AL
        ...
        private void frmTempFromPLC_R_V1o4_Resize(object sender, EventArgs e)
        {
        ...
        {
            string R01_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R01_SV.Text)), 0, 4);
            string R01_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R01_PV.Text)), 0, 4);
            string R01_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R01_AL.Text)), 0, 4);

            string R02_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R02_SV.Text)), 0, 4);
            string R02_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R02_PV.Text)), 0, 4);
            string R02_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R02_AL.Text)), 0, 4);

            string R03_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R03_SV.Text)), 0, 4);
            string R03_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R03_PV.Text)), 0, 4);
            string R03_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R03_AL.Text)), 0, 4);

            string R04_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R04_SV.Text)), 0, 4);
            string R04_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R04_PV.Text)), 0, 4);
            string R04_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R04_AL.Text)), 0, 4);

            string R05_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R05_SV.Text)), 0, 4);
            string R05_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R05_PV.Text)), 0, 4);
            string R05_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R05_AL.Text)), 0, 4);

            string R06_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R06_SV.Text)), 0, 4);
            string R06_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R06_PV.Text)), 0, 4);
            string R06_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R06_AL.Text)), 0, 4);

            string R07_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R07_SV.Text)), 0, 4);
            string R07_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R07_PV.Text)), 0, 4);
            string R07_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R07_AL.Text)), 0, 4);

            string R08_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R08_SV.Text)), 0, 4);
            string R08_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R08_PV.Text)), 0, 4);
            string R08_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R08_AL.Text)), 0, 4);

            string R09_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R09_SV.Text)), 0, 4);
            string R09_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R09_PV.Text)), 0, 4);
            string R09_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R09_AL.Text)), 0, 4);

            string R10_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R10_SV.Text)), 0, 4);
            string R10_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R10_PV.Text)), 0, 4);
            string R10_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R10_AL.Text)), 0, 4);

            string R11_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R11_SV.Text)), 0, 4);
            string R11_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R11_PV.Text)), 0, 4);
            string R11_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R11_AL.Text)), 0, 4);

            string R12_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R12_SV.Text)), 0, 4);
            string R12_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R12_PV.Text)), 0, 4);
            string R12_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R12_AL.Text)), 0, 4);

            string R13_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R13_SV.Text)), 0, 4);
            string R13_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R13_PV.Text)), 0, 4);
            string R13_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R13_AL.Text)), 0, 4);

            string R14_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R14_SV.Text)), 0, 4);
            string R14_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R14_PV.Text)), 0, 4);
            string R14_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R14_AL.Text)), 0, 4);

            string R15_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R15_SV.Text)), 0, 4);
            string R15_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R15_PV.Text)), 0, 4);
            string R15_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R15_AL.Text)), 0, 4);

            string R16_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R16_SV.Text)), 0, 4);
            string R16_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R16_PV.Text)), 0, 4);
            string R16_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R16_AL.Text)), 0, 4);

            string R17_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R17_SV.Text)), 0, 4);
            string R17_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R17_PV.Text)), 0, 4);
            string R17_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R17_AL.Text)), 0, 4);

            string R18_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R18_SV.Text)), 0, 4);
            string R18_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R18_PV.Text)), 0, 4);
            string R18_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R18_AL.Text)), 0, 4);

            string R19_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R19_SV.Text)), 0, 4);
            string R19_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R19_PV.Text)), 0, 4);
            string R19_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R19_AL.Text)), 0, 4);

            string R20_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R20_SV.Text)), 0, 4);
            string R20_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R20_PV.Text)), 0, 4);
            string R20_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_R20_AL.Text)), 0, 4);

            string P01_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P01_SV.Text)), 0, 4);
            string P01_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P01_PV.Text)), 0, 4);
            string P01_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P01_AL.Text)), 0, 4);

            string P02_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P02_SV.Text)), 0, 4);
            string P02_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P02_PV.Text)), 0, 4);
            string P02_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P02_AL.Text)), 0, 4);

            string P03_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P03_SV.Text)), 0, 4);
            string P03_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P03_PV.Text)), 0, 4);
            string P03_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P03_AL.Text)), 0, 4);

            string P04_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P04_SV.Text)), 0, 4);
            string P04_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P04_PV.Text)), 0, 4);
            string P04_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P04_AL.Text)), 0, 4);

            string P05_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P05_SV.Text)), 0, 4);
            string P05_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P05_PV.Text)), 0, 4);
            string P05_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P05_AL.Text)), 0, 4);

            string P06_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P06_SV.Text)), 0, 4);
            string P06_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P06_PV.Text)), 0, 4);
            string P06_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P06_AL.Text)), 0, 4);

            string P07_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P07_SV.Text)), 0, 4);
            string P07_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P07_PV.Text)), 0, 4);
            string P07_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P07_AL.Text)), 0, 4);

            string P08_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P08_SV.Text)), 0, 4);
            string P08_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P08_PV.Text)), 0, 4);
            string P08_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P08_AL.Text)), 0, 4);

            string P09_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P09_SV.Text)), 0, 4);
            string P09_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P09_PV.Text)), 0, 4);
            string P09_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P09_AL.Text)), 0, 4);

            string P10_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P10_SV.Text)), 0, 4);
            string P10_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P10_PV.Text)), 0, 4);
            string P10_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P10_AL.Text)), 0, 4);

            string P11_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P11_SV.Text)), 0, 4);
            string P11_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P11_PV.Text)), 0, 4);
            string P11_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P11_AL.Text)), 0, 4);

            string P12_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P12_SV.Text)), 0, 4);
            string P12_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P12_PV.Text)), 0, 4);
            string P12_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_P12_AL.Text)), 0, 4);

            string A01U_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A01U_SV.Text)), 0, 4);
            string A01U_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A01U_PV.Text)), 0, 4);
            string A01U_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A01U_AL.Text)), 0, 4);

            string A01L_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A01L_SV.Text)), 0, 4);
            string A01L_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A01L_PV.Text)), 0, 4);
            string A01L_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A01L_AL.Text)), 0, 4);

            string A02U_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A02U_SV.Text)), 0, 4);
            string A02U_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A02U_PV.Text)), 0, 4);
            string A02U_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A02U_AL.Text)), 0, 4);

            string A02L_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A02L_SV.Text)), 0, 4);
            string A02L_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A02L_PV.Text)), 0, 4);
            string A02L_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A02L_AL.Text)), 0, 4);

            string A03U_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A03U_SV.Text)), 0, 4);
            string A03U_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A03U_PV.Text)), 0, 4);
            string A03U_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A03U_AL.Text)), 0, 4);

            string A03L_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A03L_SV.Text)), 0, 4);
            string A03L_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A03L_PV.Text)), 0, 4);
            string A03L_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A03L_AL.Text)), 0, 4);

            string A04U_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A04U_SV.Text)), 0, 4);
            string A04U_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A04U_PV.Text)), 0, 4);
            string A04U_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A04U_AL.Text)), 0, 4);

            string A04L_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A04L_SV.Text)), 0, 4);
            string A04L_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A04L_PV.Text)), 0, 4);
            string A04L_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A04L_AL.Text)), 0, 4);

            string A05_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A05_SV.Text)), 0, 4);
            string A05_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A05_PV.Text)), 0, 4);
            string A05_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A05_AL.Text)), 0, 4);

            string A06_SV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A06_SV.Text)), 0, 4);
            string A06_PV = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A06_PV.Text)), 0, 4);
            string A06_AL = cls.Mid(String.Format("{0:0000}", Convert.ToInt32(lbl_A06_AL.Text)), 0, 4);

            string temp_SV = R01_SV + R02_SV + R03_SV + R04_SV + R05_SV + R06_SV + R07_SV + R08_SV + R09_SV + R10_SV + R11_SV + R12_SV + R13_SV + R14_SV + R15_SV + R16_SV + R17_SV + R18_SV + R19_SV + R20_SV
            ...
            string temp_PV = R01_PV + R02_PV + R03_PV + R04_PV + R05_PV + R06_PV + R07_PV + R08_PV + R09_PV + R10_PV + R11_PV + R12_PV + R13_PV + R14_PV + R15_PV + R16_PV + R17_PV + R18_PV + R19_PV + R20_PV
            ...
            string temp_AL = R01_AL + R02_AL + R03_AL + R04_AL + R05_AL + R06_AL + R07_AL + R08_AL + R09_AL + R10_AL + R11_AL + R12_AL + R13_AL + R14_AL + R15_AL + R16_AL + R17_AL + R18_AL + R19_AL + R20_AL
            ...
            _R01_SV = R01_SV; _R02_SV = R02_SV; _R03_SV = R03_SV; _R04_SV = R04_SV; _R05_SV = R05_SV; _R06_SV = R06_SV; _R07_SV = R07_SV; _R08_SV = R08_SV; _R09_SV = R09_SV; _R10_SV = R10_SV; _R11_SV = R11_SV; _R12_SV = R12_SV; _R13_SV = R13_SV; _R14_SV = R14_SV; _R15_SV = R15_SV; _R16_SV = R16_SV; _R17_SV = R17_SV; _R18_SV = R18_SV; _R19_SV = R19_SV; _R20_SV = R20_SV;
            _R01_PV = R01_PV; _R02_PV = R02_PV; _R03_PV = R03_PV; _R04_PV = R04_PV; _R05_PV = R05_PV; _R06_PV = R06_PV; _R07_PV = R07_PV; _R08_PV = R08_PV; _R09_PV = R09_PV; _R10_PV = R10_PV; _R11_PV = R11_PV; _R12_PV = R12_PV; _R13_PV = R13_PV; _R14_PV = R14_PV; _R15_PV = R15_PV; _R16_PV = R16_PV; _R17_PV = R17_PV; _R18_PV = R18_PV; _R19_PV = R19_PV; _R20_PV = R20_PV;
        ...
        public void fnSaveDataFile()
        {
            if (_connect == true)
            {
                int R01SV, R02SV, R03SV, R04SV, R05SV, R06SV, R07SV, R08SV, R09SV, R10SV, R11SV, R12SV, R13SV, R14SV, R15SV, R16SV, R17SV, R18SV, R19SV, R20SV;
                int R01PV, R02PV, R03PV, R04PV, R05PV, R06PV, R07PV, R08PV, R09PV, R10PV, R11PV, R12PV, R13PV, R14PV, R15PV, R16PV, R17PV, R18PV, R19PV, R20PV;
                ...
                if (_R_upd == true)
                {
                    ...
                    R19SV = (_R19_SV.Length > 0) ? Convert.ToInt32(_R19_SV) : 0;
                    R20SV = (_R20_SV.Length > 0) ? Convert.ToInt32(_R20_SV) : 0;
                    ...
                    R19PV = (_R19_PV.Length > 0) ? Convert.ToInt32(_R19_PV) : 0;
                    R20PV = (_R20_PV.Length > 0) ? Convert.ToInt32(_R20_PV) : 0;

                    for (int r = 1; r <= _mcR; r++)
                    {
                        switch (r)
                        {
                            case 1:
                            ...
                            case 18:
                                ...
                                break;
                            case 19:
                                value = now.ToString("dd/MM/yyyy HH:mm:ss") + " " + String.Format("{0:0000}", R19SV) + " " + String.Format("{0:0000}", R19PV);
                                break;
                            case 20:
                                value = now.ToString("dd/MM/yyyy HH:mm:ss") + " " + String.Format("{0:0000}", R20SV) + " " + String.Format("{0:0000}", R20PV);
                                break;
                        }
        ...
        public void fnTemperatureThread()
        {
            ...
            Thread temperWrite = new Thread(() =>
            {
                ...
                {
                    int sec = Convert.ToInt32(_dt.Second);
                    lbl_DT.Text = lbl_R_DT.Text = lbl_P_DT.Text = lbl_A_DT.Text = String.Format("{0:ss}", _dt);
                    ...
                    lbl_DT.BackColor = lbl_R_DT.BackColor = (_R_upd == true) ? Color.DodgerBlue : Color.FromKnownColor(KnownColor.Control);
                    lbl_DT.BackColor = lbl_P_DT.BackColor = (_P_upd == true) ? Color.DodgerBlue : Color.FromKnownColor(KnownColor.Control);
                    lbl_DT.BackColor = lbl_A_DT.BackColor = (_A_upd == true) ? Color.DodgerBlue : Color.FromKnownColor(KnownColor.Control);

                    chk_R_Connect.BackColor = (_R_upd == true) ? Color.DodgerBlue : Color.LightGreen;
                    chk_P_Connect.BackColor = (_P_upd == true) ? Color.DodgerBlue : Color.LightGreen;
                    chk_A_Connect.BackColor = (_A_upd == true) ? Color.DodgerBlue : Color.LightGreen;
