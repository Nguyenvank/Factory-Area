...
namespace MicrSample_Step4
{
	...
	public class FrameStep4 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRemove
			// 
			this.btnRemove.Location = new System.Drawing.Point(168, 320);
			...
			// btnExit
			// 
			this.btnExit.Location = new System.Drawing.Point(316, 320);
			...
			this.Name = "frmStep4";
			this.Text = "Step 4 Adding \"Error information\" function to Step 3.";
				...
				catch(PosControlException pex)
				{
					...
					if (pex.ErrorCode == ErrorCode.Timeout) 
					{
						...
						dialogResult = MessageBox.Show("Please insert a check."
							,"MicrSample_Step4",MessageBoxButtons.YesNo);
		...
		private void btnRemove_Click(object sender, System.EventArgs e)
		{
			...
			catch(PosControlException pex)
			{
				...
				if (pex.ErrorCode == ErrorCode.Timeout) 
				{
					MessageBox.Show("Please remove a check.","MicrSample_Step4");	
				}
			}
		}
		...
		private void frmStep4_Load(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("Failed to get device information.","MicrSample_Step4");
				//Nothing can be used.
				ChangeButtonStatus();
				return;
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","MicrSample_Step4",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				MessageBox.Show("This device has not been registered, or cannot use."
					,"MicrSample_Step4",MessageBoxButtons.OK);
			...
			{
				MessageBox.Show("Now the device is disable to use.","MicrSample_Step4"
		...
		/// <summary>
		/// Remove StatusUpdateEvent Lisnner.
		/// </summary>
		/// <param name="eventSource"></param>
		...
		protected  void OnErrorEvent(object source, DeviceErrorEventArgs e )
        {
			...
			MessageBox.Show("Micr Error\n" + "ErrorCode =" + e.ErrorCode.ToString() + "\n" 
				+ "ErrorCodeExtended =" + e.ErrorCodeExtended.ToString() ,"MicrSample_Step4"
				,MessageBoxButtons.OK);
			//<<<step4>>>--End
		}
		...
		protected void OnStatusUpdateEvent(object source, StatusUpdateEventArgs e)
        {
			...
			switch(e.Status)
			{
				...
				case PosCommon.StatusPowerOnline:
					MessageBox.Show("The device is powered on.","MicrSample_Step4"
						,MessageBoxButtons.OK);
					break;
					//The device is powered off, or unconnected.
				case PosCommon.StatusPowerOff:
					MessageBox.Show("The device is powered off","MicrSample_Step4"
						,MessageBoxButtons.OK);
					break;
