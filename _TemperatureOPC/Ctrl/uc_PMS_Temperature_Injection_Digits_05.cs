...
{
    public partial class uc_PMS_Temperature_Injection_Digits_05 : UserControl
    {
        string _msg = "", _msg_en = "", _msg_vi = "";
        int _msg_no = 0;

        int _mcRUB_Min = 1, _mcRUB_Max = 18;
        ...
        public uc_PMS_Temperature_Injection_Digits_05()
        {
            InitializeComponent();
        ...
        private void uc_PMS_Temperature_Injection_Digits_05_Load(object sender, EventArgs e)
        {
            init();
        }
        ...
        public void Fnc_Load_Data()
        {
            ...
            //        label5.Text = (_nowMiSec <= 500) ? "On" : "Off";
