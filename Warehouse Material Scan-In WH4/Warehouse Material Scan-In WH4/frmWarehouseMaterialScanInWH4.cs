...
{
    public partial class frmWarehouseMaterialScanInWH4 : Form
    {
        public string _locId = "111";     //warehouse ID
        public string _subId;           //sub-locate
        public string _matId;           //material ID
        public string _inoutIDx = "";     // for view details
        ...
        public frmWarehouseMaterialScanInWH4()
        {
            InitializeComponent();
        }
        ...
        public void initMatList()
        {
            ...
            dtpDateMFG.Enabled = false;
            dtpDateMFG.MaxDate = DateTime.Now;
            txtUsingTime.Text = "";
            txtUsingTime.Enabled = false;
            lblDateEXP.Text = "";
        ...
        private void dgvMatList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtLotNumber.Text = cls.fnGetDate("lot") + "-" + cls.fnGetDate("sn");
            txtLotNumber.Enabled = false;
            //dtpDateMFG.Value = DateTime.Now.AddDays(-1);
            dtpDateMFG.Enabled = false;
            txtUsingTime.Text = "";
            txtUsingTime.Enabled = false;
            //lblDateEXP.Text = "";
        ...
        private void dgvLocList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (quantity != "0")
            {
                ...
                if (dialogResultAdd == DialogResult.Yes)
                {
                    ...
                    //dtpDateMFG.Enabled = true;
                    //txtUsingTime.Text = "";
                    //txtUsingTime.Enabled = true;
        ...
        private void txtPackCode_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            DateTime dateMFG = dtpDateMFG.Value;
            string usingTime = txtUsingTime.Text.Trim();
                                ...
                                if (packQty > 0)
                                {
                                    ...
                                    if (dtChk.Rows.Count > 0)
                                    {
	                                    ...
	                                    if(dsExist.Tables.Count<=0 || dsExist.Tables[0].Rows.Count<=0)
	                                    {
	                                        ...
	                                        string sql = "V2o1_BASE_Warehouse_Material_ScanIn_AddItem_V1o1_Addnew";
	                                        ...
	                                        sParams[9].ParameterName = "@dateMFG";
	                                        sParams[9].Value = dateMFG;
	
	                                        sParams[10] = new SqlParameter();
	                                        sParams[10].SqlDbType = SqlDbType.Int;
	                                        sParams[10].ParameterName = "@usingTime";
	                                        sParams[10].Value = usingTime;
        ...
        private void dgvScanList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string inoutIDx = row.Cells[0].Value.ToString();
            _inoutIDx = inoutIDx;
        }
        ...
        private void txtUsingTime_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!Char.IsDigit(e.KeyChar) && !Char.IsControl(e.KeyChar))
                e.Handled = true;
        }

        private void txtUsingTime_TextChanged(object sender, EventArgs e)
        {
            DateTime mfg = dtpDateMFG.Value;
            DateTime exp;
            string usingTime = txtUsingTime.Text.Trim();
            int _usingTime = (usingTime != "" && usingTime != null) ? Convert.ToInt32(usingTime) : 0;
            if (_usingTime > 0)
            {
                exp = mfg.AddMonths(_usingTime);
            }
            else
            {
                exp = mfg;
            }
            lblDateEXP.Text = String.Format("{0:dd/MM/yyyy}", exp);
        }

        private void viewPackingDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string inoutIDx = _inoutIDx;
            frmWarehoiseMaterialScanInWH4_Details frmDetail = new frmWarehoiseMaterialScanInWH4_Details(inoutIDx);
