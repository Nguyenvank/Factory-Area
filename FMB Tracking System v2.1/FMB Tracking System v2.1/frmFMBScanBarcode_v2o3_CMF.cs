...
{
    public partial class frmFMBScanBarcode_v2o3_CMF : Form
    {
        string _packing = "", _matLot = "", _pakWeight = "", _matIDx = "";
        int ___pakWeight = 0;

        System.Windows.Forms.Form frm = System.Windows.Forms.Application.OpenForms["frmFMBScanBarcode_v2o3"];
        ...
        public frmFMBScanBarcode_v2o3_CMF()
        {
            InitializeComponent();
        }

        public frmFMBScanBarcode_v2o3_CMF(string packing, string matLot, string pakWeight, string matIDx)
        {
            InitializeComponent();
        ...
        private void frmFMBScanBarcode_v2o3_CMF_Load(object sender, EventArgs e)
        {
        ...
        private void frmFMBScanBarcode_v2o3_CMF_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public void Fnc_Save_CMF_Code()
        {
            ...
            if (code_qty == 0)
            {
                ...
                try
                {
                    ...
                    if (code_items > 0)
                    {
                        ((frmFMBScanBarcode_v2o3)frm).Fnc_Load_Save_Scan_In(packing, matLot, pakWeight, matIDx);
                    }
                    else
                    {
                        ((frmFMBScanBarcode_v2o3)frm).Fnc_Load_Not_Scan_In_Not_Save();
                    }
                }
                catch { }
                finally { }
