...
namespace Fan_1
{
    public partial class frmAssyDispenser_v1o6 : Form
    {
        public int run = 1;
        ...
        int _value01_NG = 0, _value02_NG = 0, _pulse01 = 0, _pulse02 = 0, _doubleValve_line01 = 0, _doubleValve_line02 = 0;
        ...
        public frmAssyDispenser_v1o6()
        {
            ...
            timer_PulsePLC_01 = timer_PulsePLC_02 = new System.Windows.Forms.Timer();
            timer_PulsePLC_01.Interval = timer_PulsePLC_02.Interval = 500;
            timer_PulsePLC_01.Enabled = timer_PulsePLC_02.Enabled = true;
            timer_PulsePLC_01.Stop();
            timer_PulsePLC_02.Stop();
            timer_PulsePLC_01.Tick += new System.EventHandler(timer_PulsePLC_01_Tick);
            timer_PulsePLC_02.Tick += new System.EventHandler(timer_PulsePLC_02_Tick);
        ...
        private void frmAssyDispenser_v1o6_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        private void frmAssyDispenser_v1o6_Resize(object sender, EventArgs e)
        {
        ...
        public void Fnc_Load_Dispenser_Data()
        {
            try
            {
                ...
                _doubleValve_line01 = _dis01_val = (dis01_val != "" && dis01_val != null) ? Convert.ToInt32(dis01_val) : 0;
                ...
                _doubleValve_line02 = _dis02_val = (dis02_val != "" && dis02_val != null) ? Convert.ToInt32(dis02_val) : 0;
        ...
        public void Fnc_Read_Code(int line)
        {
            ...
            switch (line)
            {
                case 4:
                    ...
                    //timer_PulsePLC_01.Enabled = true;
                    //timer_PulsePLC_01.Start();
                    break;
                case 5:
                    tagname = "Channel1.Device1.Dispenser02_SCY";
                    //timer_PulsePLC_02.Enabled = true;
                    //timer_PulsePLC_02.Start();
                    break;
            }
        ...
        private void timer_PulsePLC_01_Tick(object sender, EventArgs e)
        {
            int pulse01_Max = 0;
            switch (_doubleValve_line01)
            {
                case 0:
                    pulse01_Max = 1;
                    break;
            ...
            while (_pulse01 < pulse01_Max)
            {
                _pulse01++;
                fnReadCodeDone("Channel1.Device1.Dispenser01_SCY");
            }

            _pulse01 = pulse01_Max = 0;
            timer_PulsePLC_01.Stop();

            //if (_pulse01 < pulse_Max)
            //{
            //    fnReadCodeDone("Channel1.Device1.Dispenser01_SCY");
            //    _pulse01++;
            //}
            ...
            //    _pulse01 = 0;
            //    timer_PulsePLC_01.Stop();
            //    timer_PulsePLC_01.Enabled = false;
            //}

            //DateTime pulse = DateTime.Now;
            //int pulse_Sec = pulse.Second;
        ...
        private void timer_PulsePLC_02_Tick(object sender, EventArgs e)
        {
            int pulse02_Max = 0;
            switch (_doubleValve_line02)
            {
                case 0:
                    pulse02_Max = 1;
                    break;
            ...
            while (_pulse02 < pulse02_Max)
            {
                _pulse02++;
                fnReadCodeDone("Channel1.Device1.Dispenser02_SCY");
            }

            _pulse02 = pulse02_Max = 0;
            timer_PulsePLC_02.Stop();

            //if (_pulse02 < pulse_Max)
            //{
            //    fnReadCodeDone("Channel1.Device1.Dispenser02_SCY");
            //    _pulse02++;
            //}
            ...
            //    _pulse02 = 0;
            //    timer_PulsePLC_02.Stop();
            //    timer_PulsePLC_02.Enabled = false;
            //}
