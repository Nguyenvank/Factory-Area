...
{
    public partial class frmWarehouseMaterialScanInWH10 : Form
    {
        public string _locId = "117";     //warehouse ID
        ...
        public frmWarehouseMaterialScanInWH10()
        {
            InitializeComponent();
        }

        private void frmWarehouseMaterialScanInWH10_Load(object sender, EventArgs e)
        {
