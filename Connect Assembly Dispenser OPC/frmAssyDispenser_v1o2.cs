...
namespace Fan_1
{
    public partial class frmAssyDispenser_v1o2 : Form
    {
        public int run = 1;
        ...
        bool _export = false, _first01 = true, _first02 = true;
        ...
        private void frmAssyDispenser_v1o2_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        private void TxtDI01SCN_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtDI01SCN.Text.ToLower() == "true")
            {
                ...
                lblNGLog.Text += "Line01, " + String.Format("{0:dd/MM/yyyy HH:mm:ss}", _dt) + "\r\n";
        ...
        private void TxtDI02SCN_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtDI02SCN.Text.ToLower() == "true")
            {
                ...
                lblNGLog.Text += "Line02, " + String.Format("{0:dd/MM/yyyy HH:mm:ss}", _dt) + "\r\n";
        ...
        private void frmAssyDispenser_v1o2_Resize(object sender, EventArgs e)
        {
        ...
        public void Fnc_Create_Logging()
        {
