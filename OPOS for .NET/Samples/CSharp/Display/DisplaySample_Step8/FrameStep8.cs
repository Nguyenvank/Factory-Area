...
namespace DisplaySample_Step8
{
	/// <summary>
	/// Description of FrameStep8.
	/// </summary>
	public class FrameStep8 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnClose
			// 
			this.btnClose.Location = new System.Drawing.Point(388, 196);
			...
			this.grpGraphicDisplay.Location = new System.Drawing.Point(248, 112);
			this.grpGraphicDisplay.Name = "grpGraphicDisplay";
			this.grpGraphicDisplay.Size = new System.Drawing.Size(244, 68);
			...
			this.Name = "frmStep8";
			this.Text = "Step 8 Set the various kinds of characters.";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.frmStep8_Closing);
			this.Load += new System.EventHandler(this.frmStep8_Load);
		...
		static void Main() 
		{
			Application.Run(new FrameStep8());
		}
		...
		private void btnWindowControl_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				MessageBox.Show("When pressing OK, it ends.","DisplaySample_Step8",MessageBoxButtons.OK);
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void frmStep8_Load(object sender, System.EventArgs e)
		{
			//<<<step1>>>--Start
			...
			{
				MessageBox.Show("Failed to get device information.","DisplaySample_Step8");
				//Nothing can be used.
			...
			catch(Exception)
			{
				...
				MessageBox.Show("Failed to create instance","DisplaySample_Step8"
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("This device has not been registered, or cannot use."
					,"DisplaySample_Step8",MessageBoxButtons.OK);
			...
			catch(PosControlException)
			{
				...
				MessageBox.Show("Now the device is disable to use.","DisplaySample_Step8"
					,MessageBoxButtons.OK);	
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void frmStep8_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			//<<<step1>>>--Start
			if(m_Display != null)
			{
		...
		protected  void OnStatusUpdateEvent(object source, StatusUpdateEventArgs e)
        {
			...
			switch(e.Status)
			{
				...
				case PosCommon.StatusPowerOnline:
					MessageBox.Show("The device is powered on.","DisplaySample_Step8"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(true);
					break;
					//The device is powered off, or unconnected.
				case PosCommon.StatusPowerOff:
					MessageBox.Show("The device is powered off","DisplaySample_Step8"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(false);
					break;
				...
				case PosCommon.StatusPowerOffOffline:
					MessageBox.Show("The device is powered off or off-line.","DisplaySample_Step8"
						,MessageBoxButtons.OK);
					ChangeButtonStatus(false);
					break;
				default:
