...
{
    public partial class frmFMBScanBarcode_v2o4 : Form
    {
        ...
        private void frmFMBScanBarcode_v2o4_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
            init();
            //init_FMB_NG();
                        ...
                        if (packKind == "PRO" || packKind == "BOX")
                        {
                            if (packType == "069")
                            {
                                ...
                                if (ds.Tables.Count == 0 || ds.Tables[0].Rows.Count == 0)
                                {
                                    ...
                                    frmFMBScanBarcode_v2o4_CMF cmf = new frmFMBScanBarcode_v2o4_CMF(packing, matLot, pakWeight, matIDx);
                                    cmf.ShowDialog();
