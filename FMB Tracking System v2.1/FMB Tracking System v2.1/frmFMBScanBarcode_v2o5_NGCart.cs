...
{
    public partial class frmFMBScanBarcode_v2o5_NGCart : Form
    {
        public frmFMBScanBarcode_v2o5_NGCart()
        {
            InitializeComponent();
        }

        private void frmFMBScanBarcode_v2o5_NGCart_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }
        ...
        private void frmFMBScanBarcode_v2o5_NGCart_KeyDown(object sender, KeyEventArgs e)
        {
