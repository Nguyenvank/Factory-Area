...
{
    public partial class frmFMBScanBarcode_v2o2 : Form
    {
        ...
        public frmFMBScanBarcode_v2o2()
        {
            InitializeComponent();
        }

        private void frmFMBScanBarcode_v2o2_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
            init();
            //init_FMB_NG();
        ...
        public void Fnc_Load_Not_Save_Scan_In()
        {
            init_FMB_NG();
