...
{
    public partial class frmWarehouseCheckDate_v2 : Form
    {
        ...
        public frmWarehouseCheckDate_v2()
        {
            InitializeComponent();
        }

        private void frmWarehouseCheckDate_v2_Load(object sender, EventArgs e)
        {
        ...
        public void fnLoadData()
        {
            try
            {
                ...
                string sql = "V2o1_BASE_Warehouse_Inventory_By_Date_v2o1_SelItem_Addnew";
