...
namespace Fan_1
{
    public partial class frmAssyFromPLC_v2o3 : Form
    {
        public int run = 1;
        ...
        private void frmAssyFromPLC_v2o3_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
        ...
        private void frmAssyFromPLC_v2o3_Resize(object sender, EventArgs e)
        {
