...
{
    public partial class uc_Temperature_LiveCharts : UserControl
    {
        private static uc_Temperature_LiveCharts _instance;
        public static uc_Temperature_LiveCharts Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new uc_Temperature_LiveCharts();
                return _instance;
            }
        }
        ...
        public uc_Temperature_LiveCharts()
        {
            InitializeComponent();
        ...
        private void uc_Temperature_LiveCharts_Load(object sender, EventArgs e)
        {
            //init_Load_Data();
            fnLoadData();
