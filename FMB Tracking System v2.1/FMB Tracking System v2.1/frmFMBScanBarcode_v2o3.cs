...
{
    public partial class frmFMBScanBarcode_v2o3 : Form
    {
        ...
        private void frmFMBScanBarcode_v2o3_Load(object sender, EventArgs e)
        {
            _dt = DateTime.Now;
            init();
            //init_FMB_NG();
        ...
        public void Fnc_Load_FIFO_Items()
        {
            try
            {
                ...
                dgv_CMF_UnFiFo.ScrollBars = ScrollBars.None;
                        ...
                        if (packKind == "PRO" || packKind == "BOX")
                        {
                            if (packType == "069")
                            {
                                ...
                                if (ds.Tables.Count == 0 || ds.Tables[0].Rows.Count == 0)
                                {
                                    ...
                                    frmFMBScanBarcode_v2o3_CMF cmf = new frmFMBScanBarcode_v2o3_CMF(packing, matLot, pakWeight, matIDx);
                                    cmf.ShowDialog();
