...
{
    public partial class frmFMBScanBarcode_v2o2_CMF : Form
    {
        string _packing = "", _matLot = "", _pakWeight = "", _matIDx = "";

        System.Windows.Forms.Form frm = System.Windows.Forms.Application.OpenForms["frmFMBScanBarcode_v2o2"];
        ...
        int _time_start = 0, _time_remain = 23, _time_closed = 25;

        public frmFMBScanBarcode_v2o2_CMF()
        {
            InitializeComponent();
        }

        public frmFMBScanBarcode_v2o2_CMF(string packing, string matLot, string pakWeight, string matIDx)
        {
            InitializeComponent();
        ...
        private void frmFMBScanBarcode_v2o2_CMF_Load(object sender, EventArgs e)
        {
        ...
        private void frmFMBScanBarcode_v2o2_CMF_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public void Fnc_Save_CMF_Code()
        {
            ...
            try
            {
                ...
                if (code_items > 0)
                {
                    ((frmFMBScanBarcode_v2o2)frm).Fnc_Load_Save_Scan_In(packing, matLot, pakWeight, matIDx);
                }
                else
                {
                    ((frmFMBScanBarcode_v2o2)frm).Fnc_Load_Not_Save_Scan_In();
                }
            }
            catch { }
            finally { }
