...
namespace Inventory_Data
{
    public partial class frmSub02ScanInMaterial : Form
    {
        ...
        public frmSub02ScanInMaterial()
        {
            ...
            mnuPanel.MenuItems.Add(new MenuItem("Làm mới dữ liệu", fn_TabPage8_Refresh_Click));
            mnuPanel.MenuItems.Add(new MenuItem("-"));
            mnuPanel.MenuItems.Add(new MenuItem("Copy dữ liệu", fn_TabPage8_Copy_Click));
            //mnuPanel.MenuItems.Add(new MenuItem("-"));
            //mnuPanel.MenuItems.Add(new MenuItem("Xuất dữ liệu ra Excel", fn_TabPage8_Excel_Click));
            tabPage8.ContextMenu = mnuPanel;
        }
        ...
        public void initBinding_Inventory()
        {
            try
            {
                string sql = "V2o1_BASE_SubMaterial02_Init_Binding_Inventory_List_SelItem_V1o2_Addnew";
                DataTable dt = new DataTable();
                dt = cls.fnSelect(sql);
                ...
                dgvBinding_Inventory.Columns[2].Width = 15 * _dgvBinding_Invent_Width / 100;    // BarCode
                dgvBinding_Inventory.Columns[3].Width = 11 * _dgvBinding_Invent_Width / 100;    // Location
                dgvBinding_Inventory.Columns[4].Width = 5 * _dgvBinding_Invent_Width / 100;    // Uom
                dgvBinding_Inventory.Columns[5].Width = 8 * _dgvBinding_Invent_Width / 100;    // 1-Day Using
                dgvBinding_Inventory.Columns[6].Width = 8 * _dgvBinding_Invent_Width / 100;    // Safety Stock
                dgvBinding_Inventory.Columns[7].Width = 8 * _dgvBinding_Invent_Width / 100;    // Total
                dgvBinding_Inventory.Columns[8].Width = 15 * _dgvBinding_Invent_Width / 100;    // IN_Date
                //dgvBinding_Inventory.Columns[9].Width = 15 * _dgvBinding_Invent_Width / 100;    // ImageStatus
                ...
                dgvBinding_Inventory.Columns[8].Visible = true;
                dgvBinding_Inventory.Columns[9].Visible = false;

                dgvBinding_Inventory.Columns[8].DefaultCellStyle.Format = "dd/MM/yyyy HH:mm";
        ...
        {
            string sql = "V2o1_BASE_SubMaterial02_Init_Location_List_SelItem_V1o2_Addnew";
            DataTable dt = new DataTable();
            dt = cls.fnSelect(sql);
            ...
            dgvLocate_List.Columns[1].Width = 65 * _dgvLocate_List_Width / 100;    // Name
            //dgvLocate_List.Columns[2].Width = 10 * _dgvLocate_List_Width / 100;    // Barcode
            dgvLocate_List.Columns[3].Width = 20 * _dgvLocate_List_Width / 100;    // Sublocation
            dgvLocate_List.Columns[4].Width = 15 * _dgvLocate_List_Width / 100;    // Sublocation
            ...
            dgvLocate_List.Columns[4].Visible = true;
            ...
            dgvLocate_List.Columns[4].ReadOnly = true;
            ...
            txtLocate_filter.Text = "";
            txtLocate_filter.Enabled = (dgvLocate_List.Rows.Count > 0) ? true : false;
        }
        ...
        {
            frmSub02ScanInMaterial_LocateCreate loc = new frmSub02ScanInMaterial_LocateCreate();
            loc.ShowDialog();
        }
        ...
        public void initTransfer_List()
        {
            ...
            dgvTransfer_List.Columns[1].Width = 70 * _dgvTransfer_List_Width / 100;    // Name
            //dgvTransfer_List.Columns[2].Width = 10 * _dgvTransfer_List_Width / 100;    // Barcode
            dgvTransfer_List.Columns[3].Width = 30 * _dgvTransfer_List_Width / 100;    // Sublocation
        ...
        private void txtTransfer_Filter_TextChanged(object sender, EventArgs e)
        {
            cls.fnFilterDatagridRow(dgvTransfer_List, txtTransfer_Filter, 1);
        }

        private void txtLocate_filter_TextChanged(object sender, EventArgs e)
        {
            cls.fnFilterDatagridRow(dgvLocate_List, txtLocate_filter, 1);
        }
        ...
        private void fn_TabPage8_Refresh_Click(object sender, EventArgs e)
        {
            initBinding_Inventory();
        }

        private void fn_TabPage8_Copy_Click(object sender, EventArgs e)
        {
            cls.fnCopyDatagridviewContent(dgvBinding_Inventory, tssMessage);
        }

        private void fn_TabPage8_Excel_Click(object sender, EventArgs e)
        {
            cls.ExportToExcel_v2(dgvBinding_Inventory);
        }
